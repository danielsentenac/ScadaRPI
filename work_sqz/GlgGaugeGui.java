...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", SQZSTATUS.get(origin));
       STATUS.put("Gestatus", SQZSTATUS.get(origin));
       STATUS.put("GePstatus", SQZSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", SQZSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", SQZSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", SQZSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", SQZSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", SQZSTATUS.get(origin));
       STATUS.put("GePStr", SQZSTATUS.get(origin + "Psub"));
    }
