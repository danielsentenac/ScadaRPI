...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : SQZSTATUS.entrySet()) {
         ...
         if ( device != null ) {
            ...
            try {
               ...
               if (!glgName.contains("sub") &&  
                  ...
                  else if (glgName.startsWith("TurboP21")) 
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("SqzStatusDetails") )
                          child = new GlgSqzStatusDetailsGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("SqzTemp") )
                          child = new GlgSqzTempGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("SqzVacuum") )
                          child = new GlgSqzVacuumGui(parent, deviceManager, title, origin);
