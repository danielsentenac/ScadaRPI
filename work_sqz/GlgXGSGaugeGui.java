...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", SQZSTATUS.get(origin));
       STATUS.put("XGSGeEstatus", SQZSTATUS.get(origin));
       STATUS.put("XGSGeDstatus", SQZSTATUS.get(origin));
       STATUS.put("XGSGeVal", SQZSTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", SQZSTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", SQZSTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", SQZSTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", SQZSTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", SQZSTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", SQZSTATUS.get(origin + "Fsub"));
    }
