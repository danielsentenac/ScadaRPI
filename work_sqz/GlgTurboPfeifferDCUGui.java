...
public class GlgTurboPfeifferDCUGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PErr", SQZSTATUS.get(origin));
       STATUS.put("PErrCol", SQZSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", SQZSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrVal", SQZSTATUS.get(origin + "ErrValsub"));
       STATUS.put("PSty", SQZSTATUS.get(origin));
       STATUS.put("PStyCol", SQZSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", SQZSTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", SQZSTATUS.get(origin));
       STATUS.put("PTempCol", SQZSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", SQZSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempVal", SQZSTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTemp", SQZSTATUS.get(origin));
       STATUS.put("PBTempCol", SQZSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", SQZSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempVal", SQZSTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", SQZSTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", SQZSTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", SQZSTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", SQZSTATUS.get(origin + "HoursValsub"));      
    }
