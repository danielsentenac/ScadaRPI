...
String mainDrawing = "SQZ.g";

/***********************************************************************/
Hashtable<String, String> SQZCMD = new Hashtable<String, String>(){
...
put("Ge1","MG_PR3ONOFF");                   // Type 2 (TRIGGER)
put("Ge3","MG_PR4ONOFF");                   // Type 2 (TRIGGER)
put("Ge2","MG_PR5ONOFF");                   // Type 2 (TRIGGER)
put("Gp","MG_PR6ONOFF");                    // Type 2 (TRIGGER)
//
// Valves
//
...
put("V24","M2_V24CMD");           // Type 2 (TRIGGER)
put("V25","M2_V25CMD");           // Type 2 (TRIGGER)
put("Vp","M2_VPCMD");             // Type 2 (TRIGGER)
//put("VSpare","M2_VSPARECMD");   // Type 2 (TRIGGER)
//
// Dry Pumps
//
...
put("BypassGp","M2_BYPASSONOFF"); // Type 2 (TRIGGER)

//
// Fan
//
put("Fan","M3_FANONOFF");// Type 2 (TRIGGER)
put("FanSpeed","M3_FANSPEED"); // Type 5 (READ_AND_WRITE_STATUS)
...
put("Ge4emission","RGAGe4_EMISSIONONOFF"); // Type 2 (TRIGGER)
put("Ge4degas","RGAGe4_DEGASONOFF");       // Type 2 (TRIGGER)
put("Ge4SEM","RGAGe4_SEMONOFF");           // Type 2 (TRIGGER)


}};
/***********************************************************************/
Hashtable<String, String> SQZSTATUS = new Hashtable<String, String>(){
...
put("Vp","M2_VPST");
put("VpCol","M2_VPST");
//put("VSpare","M2_VSPAREST");
//put("VSpareCol","M2_VSPAREST");
put("Ve1","M2_VE1ST");
put("Ve1Col","M2_VE1ST");
put("Ve2","M2_VE2ST");
put("Ve2Col","M2_VE2ST");
...
put("Ge1","MG_PR3SST");     // D resource type (visibility)
put("Ge1Psub","MG_PR3ST");     // D resource type (visibility)
put("Ge1Val","MG_PR3");    // D resource type
put("Ge1Col","MG_PR3SST");  // G resource type
put("Ge1PColsub","MG_PR3ST");  // G resource type
put("Ge3","MG_PR4SST");     // D resource type (visibility)
put("Ge3Psub","MG_PR4ST");     // D resource type (visibility)
put("Ge3Val","MG_PR4");    // D resource type
put("Ge3Col","MG_PR4SST");  // G resource type
put("Ge3PColsub","MG_PR4ST");  // G resource type
put("Ge2","MG_PR5SST");     // D resource type (visibility)
put("Ge2Psub","MG_PR5ST");     // D resource type (visibility)
put("Ge2Val","MG_PR5");    // D resource type
put("Ge2Col","MG_PR5SST");  // G resource type
put("Ge2PColsub","MG_PR5ST");  // G resource type
put("Gp","MG_PR6SST");     // D resource type (visibility)
put("GpPsub","MG_PR6ST");     // D resource type (visibility)
put("GpVal","MG_PR6");    // D resource type
put("GpCol","MG_PR6SST");  // G resource type
put("GpPColsub","MG_PR6ST");  // G resource type
...
//
/***********************************************************************/
Hashtable<String, String> SqzStatusDetails = new Hashtable<String, String>(){
...
put("BypassGp","M2_BYPASSST");
put("BypassGpStr","M2_BYPASSST");
put("BypassGpCol","M2_BYPASSST");
// Rack
put("FanSpeed","M3_FANSPEED");
put("FanSpeedStr","M3_FANSPEED");
put("FanSpeedCol","M3_FANSPEED");
put("FanStatus","M3_FANST");
put("FanStatusStr","M3_FANST");
put("FanStatusCol","M3_FANST");
put("RackTempVal","M3_TEMP");
}};

//
// SQZ Temperature sensors
//
/***********************************************************************/
Hashtable<String, String> SqzTemp = new Hashtable<String, String>(){
...
// Vacuum status
//
Hashtable<Integer, String> VacuumSTATUS = new Hashtable<Integer, String>(){

private static final long serialVersionUID = 454054054059L;
{
put(0,"- READY FOR VACUUM");
put(1,"- VACUUM STARTED");
put(22,"- P22 NOT YET SWITCHED ON..");
put(2,"- P22 SWITCHED ON");
put(33,"- BYPASS G22 NOT YET SWITCHED ON...");
put(3,"- BYPASS G22 SWITCHED ON");
put(44,"- V1 NOT YET OPENED...");
put(4,"- V1 OPENED");
put(55,"- V22 NOT YET OPENED...");
put(5,"- V22 OPENED");
put(66,"- WAITING Ge2 < 800 MBAR...");
put(6,"- Ge2 < 800 MBAR");
put(77,"- V22 NOT YET CLOSED...");
put(7,"- V22 CLOSED");
put(88,"- WAITING Ge2 STABLE (+/- 10 MBAR)...");
put(8,"- Ge2 STABLE (+/- 10 MBAR)");
put(99,"- V22 NOT YET OPENED...");
put(9,"- V22 OPENED");
put(100,"- WAITING Ge1 < 0.5 MBAR...");
put(10,"- Ge1 < 0.5 MBAR");
put(111,"- V1 NOT YET CLOSED...");
put(11,"- V1 CLOSED");
put(122,"-  P21 NOT YET ON...");
put(12,"- P21 ON");
put(133,"- WAITING P21 TO REACH SPEED 400HZ");
put(13,"- P21 REACHED SPEED 400HZ");
put(144,"- V21 NOT YET OPENED...");
put(14,"- V21 OPENED");
put(155,"- WAITING G22 < 0.5 MBAR...");
put(15,"- G22 < 0.5 MBAR");
put(166,"- WAITING FOR BYPASS G22 OFF...");
put(16,"- BYPASS G22 OFF");
put(250,"- CHECK INSTRUMENT COMMUNICATION");
put(251,"- MISSING VACUUM INITIAL CONDITIONS");
put(252,"- IN AIR");
put(253,"- IN VACUUM");
put(254,"- STOPPED - G22 NOT STABLE");
put(255,"- STOPPED - COULD NOT CLOSE V1");
put(256,"- STOPPED - COULD SWITCH ON P21");
put(257,"- STOPPED - COULD NOT CLOSE V21");
}};


Hashtable<Integer,GlgPoint> VacuumColorSTATUS = new Hashtable<Integer, GlgPoint>(){

private static final long serialVersionUID = 554054054061L;
{
put(0,new GlgPoint(0.,1.,0.));
put(1,new GlgPoint(1.,0.7,0.));
put(22,new GlgPoint(0.,1.,0.));
put(2,new GlgPoint(0.,1.,0.5));
put(33,new GlgPoint(0.,1.,0.));
put(3,new GlgPoint(0.,1.,0.5));
put(44,new GlgPoint(0.,1.,0.));
put(4,new GlgPoint(0.,1.,0.5));
put(55,new GlgPoint(0.,1.,0.));
put(5,new GlgPoint(0.,1.,0.5));
put(66,new GlgPoint(0.,1.,0.));
put(6,new GlgPoint(0.,1.,0.5));
put(77,new GlgPoint(0.,1.,0.));
put(7,new GlgPoint(0.,1.,0.5));
put(88,new GlgPoint(0.,1.,0.));
put(8,new GlgPoint(0.,1.,0.5));
put(99,new GlgPoint(0.,1.,0.));
put(9,new GlgPoint(0.,1.,0.5));
put(100,new GlgPoint(0.,1.,0.));
put(10,new GlgPoint(0.,1.,0.5));
put(111,new GlgPoint(0.,1.,0.));
put(11,new GlgPoint(0.,1.,0.5));
put(122,new GlgPoint(0.,1.,0.));
put(12,new GlgPoint(0.,1.,0.5));
put(133,new GlgPoint(0.,1.,0.));
put(13,new GlgPoint(0.,1.,0.5));
put(144,new GlgPoint(0.,1.,0.));
put(14,new GlgPoint(0.,1.,0.5));
put(155,new GlgPoint(0.,1.,0.));
put(15,new GlgPoint(0.,1.,0.5));
put(166,new GlgPoint(0.,1.,0.));
put(16,new GlgPoint(0.,1.,0.5));
put(250,new GlgPoint(1.,0.,0.));
put(251,new GlgPoint(1.,0.,0.));
put(252,new GlgPoint(0.5,0.7,0.5));
put(253,new GlgPoint(0.5,0.7,0.));
put(254,new GlgPoint(1.,0.,0.));
put(255,new GlgPoint(1.,0.,0.));
put(256,new GlgPoint(1.,0.0,0.0));
put(257,new GlgPoint(1.,0.0,0.0));
put(255,new GlgPoint(1.,0.0,0.0));
}};

//
// Vacuum Com status
//
Hashtable<Integer, String> VacuumComSTATUS = new Hashtable<Integer, String>(){

private static final long serialVersionUID = 654054054059L;
{
put(0,"- Ok");
put(1,"- Failure");
put(255,"- ?");
...
Hashtable<Integer,GlgPoint> VacuumComColorSTATUS = new Hashtable<Integer, GlgPoint>(){

private static final long serialVersionUID = 754054054061L;
{
put(0,new GlgPoint(0.,1.0,0.));
put(1,new GlgPoint(1.,0.0,0.0));
