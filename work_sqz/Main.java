...
public class Main {
    ...
    public static void main(String[] args) 
        ...
        Device dcu = new TurboPfeifferDCU("DCU",
                                          ...
                                          "/dev/serial/by-id/usb-FTDI_USB-COM485_Plus4_FT2Z69WT-if01-port0", 
                                          Baud._9600, 
                                          DataBits._8,  
                                          Parity.NONE, 
                                          StopBits._1, 
        ...
        /**********************************************************************************************/
        // Create Vacuum device
        Device vacuum = new Vacuum("VAC", tcmuxshield.mbRegisterEnd, // Modbus start offset
                                          deviceManager);
        ...
        /**********************************************************************************************/
        // Create Rga Qms200 (from Pfeiffer) device
        ...
        tcmuxshield.doStart();
        // Start (Vacuum) vacuum device
        vacuum.doStart();
        // Start (RgaPfeifferQms200) rga device
        //qms200.doStart();
