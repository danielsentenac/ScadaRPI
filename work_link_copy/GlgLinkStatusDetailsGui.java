/*
 * This Class is used for LinkStatusDetails GUI using Glg Toolkit
 */
...
public class GlgLinkStatusDetailsGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgLinkStatusDetailsGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // LinkStatusDetails display
          glg_bean.SetDrawingFile("LinkStatusDetails.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // LinkStatusDetails Gui case
       STATUS.clear();
       STATUS.putAll(LinkStatusDetails);
    }
	...
	public void InputCallback( GlgObject viewport, GlgObject message_obj )  {
	   ...
	   subaction = message_obj.GetSResource( "SubAction" );
           ...
           else if ((action.equals("MouseClick") ) && origintag.contains("BypassG22lpON")) {
              String cmdName =  CMD.get("BypassG22lp");
              logger.finer("Origin=" + origintag + " Format=" + format + " Action=" + action + " subAction=" + subaction);
           ...
           else if ((action.equals("MouseClick") ) && origintag.contains("BypassG22lpOFF")) {
              String cmdName =  CMD.get("BypassG22lp");
              if ( cmdName == null ) return; 
              // Get corresponding device from deviceManager
              String deviceName = cmdName.split("_",2)[0];
           ...
           else if ((action.equals("MouseClick") ) && origintag.contains("BypassG22lsON")) {
              String cmdName =  CMD.get("BypassG22ls");
              if ( cmdName == null ) return; 
              // Get corresponding device from deviceManager
              String deviceName = cmdName.split("_",2)[0];
              Device device = deviceManager.getDevice(deviceName);  
           ...
           else if ((action.equals("MouseClick") ) && origintag.contains("BypassG22lsOFF")) {
              String cmdName =  CMD.get("BypassG22ls");
              if ( cmdName == null ) return; 
              // Get corresponding device from deviceManager
              String deviceName = cmdName.split("_",2)[0];
