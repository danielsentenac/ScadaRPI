   ...
   public void executeCommand( DataElement e ) {
      ...
      try {
         ...
         if ( e.name.contains("V21CMD") ) { // Valve V21 Open/Close command
            ...
            logger.finer("Controllino_2:executeCommand> set bit V22 =" + e.value);
            if ( e.value == 1 )      // Open Valve
            ...
            logger.finer("Controllino_2:executeCommand> set bit V1 =" + e.value);
            if ( e.value == 1 )      // Open Valve
            ...
            logger.finer("Controllino_2:executeCommand> set bit P22 =" + e.value);
