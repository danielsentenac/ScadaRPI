...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", LINKSTATUS.get(origin));
       STATUS.put("XGSGeEstatus", LINKSTATUS.get(origin));
       STATUS.put("XGSGeDstatus", LINKSTATUS.get(origin));
       STATUS.put("XGSGeVal", LINKSTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", LINKSTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", LINKSTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", LINKSTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", LINKSTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", LINKSTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", LINKSTATUS.get(origin + "Fsub"));
    }
