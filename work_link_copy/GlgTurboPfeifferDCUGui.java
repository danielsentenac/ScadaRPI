...
public class GlgTurboPfeifferDCUGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054075L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgTurboPfeifferDCUGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          glg_bean.SetDrawingFile("TurboPfeifferDCU.g");
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PErr", LINKSTATUS.get(origin));
       STATUS.put("PErrCol", LINKSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", LINKSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrVal", LINKSTATUS.get(origin + "ErrValsub"));
       STATUS.put("PSty", LINKSTATUS.get(origin));
       STATUS.put("PStyCol", LINKSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", LINKSTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", LINKSTATUS.get(origin));
       STATUS.put("PTempCol", LINKSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", LINKSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempVal", LINKSTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTemp", LINKSTATUS.get(origin));
       STATUS.put("PBTempCol", LINKSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", LINKSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempVal", LINKSTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", LINKSTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", LINKSTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", LINKSTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", LINKSTATUS.get(origin + "HoursValsub"));      
    }
