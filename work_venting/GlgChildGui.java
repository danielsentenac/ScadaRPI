...
public abstract class GlgChildGui extends JFrame implements ChannelList, DataTypes, Runnable {
    ...
    public GlgChildGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
       ...
       title = _title;
       parent = _parent;
       if ( origin.equals("MKS2000"))
          op = _parent.op2000;
       else if ( origin.equals("MKS50000"))
          op = _parent.op50000;
       child = this;
    ...
    protected void updateGui() {
      ...
      for (Map.Entry<String, String> e : STATUS.entrySet()) {
         ...
         //System.out.println("GlgChildGui:updateGui> glgName=" + glgName + " dataName=" + dataName);
         ...
         // Get corresponding data element from device
            ...
            //System.out.println("GlgChildGui:updateGui> glgName=" + glgName + " dataElement name=" + 
