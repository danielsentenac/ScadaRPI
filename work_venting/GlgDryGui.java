...
public class GlgDryGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Dry Gui case
       STATUS.clear();
       STATUS.put("Pname", VENTINGSTATUS.get(origin));
       STATUS.put("P", VENTINGSTATUS.get(origin));
       STATUS.put("PCol", VENTINGSTATUS.get(origin + "Col"));
       STATUS.put("PStr", VENTINGSTATUS.get(origin));
    }
