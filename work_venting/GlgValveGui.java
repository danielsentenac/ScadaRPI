...
public class GlgValveGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Valve Gui case
       STATUS.clear();
       STATUS.put("Vname", VENTINGSTATUS.get(origin));
       STATUS.put("Vstatus", VENTINGSTATUS.get(origin));
       STATUS.put("VCol", VENTINGSTATUS.get(origin + "Col"));
       STATUS.put("VStr", VENTINGSTATUS.get(origin));
