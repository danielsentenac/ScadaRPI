...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", VENTINGSTATUS.get(origin));
       STATUS.put("Gestatus", VENTINGSTATUS.get(origin));
       STATUS.put("GePstatus", VENTINGSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", VENTINGSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", VENTINGSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", VENTINGSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", VENTINGSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", VENTINGSTATUS.get(origin));
       STATUS.put("GePStr", VENTINGSTATUS.get(origin + "Psub"));
    }
