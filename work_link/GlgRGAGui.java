...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", LINKSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", LINKSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", LINKSTATUS.get(origin + "emissionsub"));
       ...
       STATUS.put("RGAfilament", LINKSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", LINKSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", LINKSTATUS.get(origin + "filamentsub"));
