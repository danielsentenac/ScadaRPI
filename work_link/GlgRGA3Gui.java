...
public class GlgRGA3Gui extends GlgChildGui {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // Get RGA amuMax paramenter         
          RgaHidenHal201RC hal201rc = (RgaHidenHal201RC) deviceManager.getDevice("RGA" + origin);
          amuMax = hal201rc.amuMax;
          logger.fine("GlgRGA3Gui::createAndShowGui> loading drawing RGA" + amuMax + ".g");
          glg_bean.SetDrawingFile("RGA" + amuMax + ".g");
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAoperation", LINKSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationCol", LINKSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationStr", LINKSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAdegas", LINKSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", LINKSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", LINKSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", LINKSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", LINKSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", LINKSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", LINKSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", LINKSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", LINKSTATUS.get(origin + "modesub"));
       STATUS.put("FilamentStatus", LINKSTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusCol", LINKSTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusStr", LINKSTATUS.get(origin + "filamentsub"));
       STATUS.put("ElectronEnergy", LINKSTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyCol", LINKSTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyStr", LINKSTATUS.get(origin + "electronenergysub"));
       STATUS.put("Emission", LINKSTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionCol", LINKSTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionStr", LINKSTATUS.get(origin + "emissionsub"));
       STATUS.put("Multiplier", LINKSTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierCol", LINKSTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierStr", LINKSTATUS.get(origin + "multipliersub"));
       STATUS.put("Focus", LINKSTATUS.get(origin + "focussub"));
       STATUS.put("FocusCol", LINKSTATUS.get(origin + "focussub"));
       STATUS.put("FocusStr", LINKSTATUS.get(origin + "focussub"));
       STATUS.put("Cage", LINKSTATUS.get(origin + "cagesub"));
       STATUS.put("CageCol", LINKSTATUS.get(origin + "cagesub"));
       STATUS.put("CageStr", LINKSTATUS.get(origin + "cagesub"));
       ...
       for ( int j = 0 ; j < amuMax ; j++) {// RGA data (plot)
          int index = j + 1;
	...
	public void InputCallback( GlgObject viewport, GlgObject message_obj )  {
	   ...
	   subaction = message_obj.GetSResource( "SubAction" );
           ...
           // RGA Degas ON/OFF command
              ...
              logger.fine("GlgRgaGui::InputListener> Open Dialog command for " + origin + "," + origintag );
              String cmdName =  STATUS.get(origintag);
              logger.fine("GlgRgaGui::InputListener> Open Dialog command for " + cmdName );
              String deviceName = cmdName.split("_",2)[0];
              Device device = deviceManager.getDevice(deviceName);
              DataElement dataElement = device.getDataElement(cmdName.split("_",2)[1]);
              if (dataElement != null) {
