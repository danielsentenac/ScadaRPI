...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : LINKSTATUS.entrySet()) {
         ...
         if ( device != null ) {
            ...
            try {
               ...
               if (!glgName.contains("sub") &&  
                  ...
                  if (glgName.startsWith("G") && !glgName.contains("Ge4") && !glgName.contains("Gc4")) {
                    ...
                    glg_bean.SetGTag(glgName, RelayGeneralColorSTATUS.get((int)dataElement.value), true);
                  else if (glgName.startsWith("Ge4") || glgName.startsWith("Gc4"))
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("LinkStatusDetails") )
                          child = new GlgLinkStatusDetailsGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("LinkTemp") )
                          child = new GlgLinkTempGui(parent, deviceManager, title, origin);
                       else if ( origin.startsWith("Ge4") || origin.startsWith("Gc4"))
