...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", LINKSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", LINKSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", LINKSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", LINKSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", LINKSTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", LINKSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", LINKSTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", LINKSTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", LINKSTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", LINKSTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", LINKSTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", LINKSTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", LINKSTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", LINKSTATUS.get(origin + "ScurrentValsub"));
    }
