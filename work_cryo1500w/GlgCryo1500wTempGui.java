/*
 * This Class is used for Cryo1500wTemp GUI using Glg Toolkit
 */
...
public class GlgCryo1500wTempGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgCryo1500wTempGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // Cryo1500wTemp display
          glg_bean.SetDrawingFile("Cryo1500wTemp.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Cryo1500wTemp Gui case
       STATUS.clear();
       STATUS.putAll(Cryo1500wTemp);
    }
