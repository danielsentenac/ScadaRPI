...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", CRYO1500WSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", CRYO1500WSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", CRYO1500WSTATUS.get(origin + "emissionsub"));
       ...
       STATUS.put("RGAfilament", CRYO1500WSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", CRYO1500WSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", CRYO1500WSTATUS.get(origin + "filamentsub"));
