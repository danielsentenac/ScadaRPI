...
public class GlgCryo1500wStatusDetailsGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgCryo1500wStatusDetailsGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          glg_bean.SetDrawingFile("Cryo1500wStatusDetails.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.clear();
       STATUS.putAll(Cryo1500wStatusDetails);
    }
