...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", CRYO1500WSTATUS.get(origin));
       STATUS.put("Gestatus", CRYO1500WSTATUS.get(origin));
       STATUS.put("GePstatus", CRYO1500WSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", CRYO1500WSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", CRYO1500WSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", CRYO1500WSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", CRYO1500WSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", CRYO1500WSTATUS.get(origin));
       STATUS.put("GePStr", CRYO1500WSTATUS.get(origin + "Psub"));
    }
