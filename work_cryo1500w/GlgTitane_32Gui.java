...
public class GlgTitane_32Gui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PStart", CRYO1500WSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartCol", CRYO1500WSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartStr", CRYO1500WSTATUS.get(origin + "Startsub"));
       STATUS.put("PCtrl", CRYO1500WSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlCol", CRYO1500WSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlStr", CRYO1500WSTATUS.get(origin + "Ctrlsub"));
       ...
       STATUS.put("PREmode", CRYO1500WSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeCol", CRYO1500WSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeStr", CRYO1500WSTATUS.get(origin + "REmodesub"));
       STATUS.put("PFILmode", CRYO1500WSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeCol", CRYO1500WSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeStr", CRYO1500WSTATUS.get(origin + "FILmodesub"));
       STATUS.put("POPmode", CRYO1500WSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeCol", CRYO1500WSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeStr", CRYO1500WSTATUS.get(origin + "OPmodesub"));
       STATUS.put("PCTRLOPmode", CRYO1500WSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeCol", CRYO1500WSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeStr", CRYO1500WSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PAcurrentVal", CRYO1500WSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PAvoltageVal", CRYO1500WSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PSublcurrentVal", CRYO1500WSTATUS.get(origin + "SublcurrentValsub"));
       STATUS.put("PSubltimeVal", CRYO1500WSTATUS.get(origin + "SubltimeValsub"));
       STATUS.put("PSublperiodVal", CRYO1500WSTATUS.get(origin + "SublperiodValsub"));
       STATUS.put("PSublwaitVal", CRYO1500WSTATUS.get(origin + "SublwaitValsub"));
       STATUS.put("PCycleVal", CRYO1500WSTATUS.get(origin + "CycleValsub"));
       STATUS.put("PHrVal", CRYO1500WSTATUS.get(origin + "HrValsub"));
