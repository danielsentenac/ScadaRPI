...
public class GlgRGA2Gui extends GlgChildGui {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          glg_bean.SetDrawingFile("RGA2.g");
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAoperation", CRYO1500WSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationCol", CRYO1500WSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationStr", CRYO1500WSTATUS.get(origin + "operationsub"));
       STATUS.put("RGAdegas", CRYO1500WSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", CRYO1500WSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", CRYO1500WSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", CRYO1500WSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", CRYO1500WSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", CRYO1500WSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", CRYO1500WSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", CRYO1500WSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", CRYO1500WSTATUS.get(origin + "modesub"));
       STATUS.put("FilamentStatus", CRYO1500WSTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusCol", CRYO1500WSTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusStr", CRYO1500WSTATUS.get(origin + "filamentsub"));
       STATUS.put("ElectronEnergy", CRYO1500WSTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyCol", CRYO1500WSTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyStr", CRYO1500WSTATUS.get(origin + "electronenergysub"));
       STATUS.put("Emission", CRYO1500WSTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionCol", CRYO1500WSTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionStr", CRYO1500WSTATUS.get(origin + "emissionsub"));
       STATUS.put("Multiplier", CRYO1500WSTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierCol", CRYO1500WSTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierStr", CRYO1500WSTATUS.get(origin + "multipliersub"));
       STATUS.put("Focus", CRYO1500WSTATUS.get(origin + "focussub"));
       STATUS.put("FocusCol", CRYO1500WSTATUS.get(origin + "focussub"));
       STATUS.put("FocusStr", CRYO1500WSTATUS.get(origin + "focussub"));
       STATUS.put("Cage", CRYO1500WSTATUS.get(origin + "cagesub"));
       STATUS.put("CageCol", CRYO1500WSTATUS.get(origin + "cagesub"));
       STATUS.put("CageStr", CRYO1500WSTATUS.get(origin + "cagesub"));
