...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : CRYO1500WSTATUS.entrySet()) {
         ...
         if ( device != null ) {
            ...
            try {
               ...
               if (!glgName.contains("sub") &&  
                  ...
                  if ((glgName.startsWith("G") || glgName.startsWith("C")) && !glgName.contains("Ge4")) {
                  ...
                  else if (glgName.startsWith("Bypass"))
	...
	public void InputCallback( GlgObject viewport, GlgObject message_obj )  {
	   ...
	   subaction = message_obj.GetSResource( "SubAction" );
           ...
           if ((action.equals("MouseClick") || action.equals("Activate") )&& origin.equals("EXIT")) { // Cicked on EXIT button
            ...
            // Bypass ON command
           else if ((action.equals("MouseClick") || action.equals("Activate")) && origin.contains("BypassON")) {
           logger.fine("GlgGui:InputListener> BYPASS ON Origin=" + origin + " Format=" + format + " Action=" + action +
                              " subAction=" + subaction);
              String cmdName =  CRYO1500WCMD.get("Bypass");
           ...
           // Bypass OFF command
           else if ((action.equals("MouseClick") || action.equals("Activate")) && origin.contains("BypassOFF")) {
              String cmdName =  CRYO1500WCMD.get("Bypass");
              if ( cmdName == null ) return; 
              // Get corresponding device from deviceManager
              String deviceName = cmdName.split("_",2)[0];
              ...
              logger.fine("GlgGui:InputListener> Origin=" + origin + " Format=" + format + " Action=" + action +
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("Cryo1500wStatusDetails") )
                          child = new GlgCryo1500wStatusDetailsGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("Cryo1500wTemp") )
                          child = new GlgCryo1500wTempGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("Cryo1500wInt") )
                          child = new GlgCryo1500wIntGui(parent, deviceManager, title, origin);
                       else if ( (origin.startsWith("G") || origin.startsWith("C")) && !origin.contains("Val") && !origin.contains("Ge4"))
                       ...
                       else if ( origin.equals("TurboTPI") || origin.equals("TurboTPO") )
