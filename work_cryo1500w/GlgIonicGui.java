...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", CRYO1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", CRYO1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", CRYO1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", CRYO1500WSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", CRYO1500WSTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", CRYO1500WSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", CRYO1500WSTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", CRYO1500WSTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", CRYO1500WSTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", CRYO1500WSTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", CRYO1500WSTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", CRYO1500WSTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", CRYO1500WSTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", CRYO1500WSTATUS.get(origin + "ScurrentValsub"));
    }
