...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", CRYO1500WSTATUS.get(origin));
       STATUS.put("XGSGeEstatus", CRYO1500WSTATUS.get(origin));
       STATUS.put("XGSGeDstatus", CRYO1500WSTATUS.get(origin));
       STATUS.put("XGSGeVal", CRYO1500WSTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", CRYO1500WSTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", CRYO1500WSTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", CRYO1500WSTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", CRYO1500WSTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", CRYO1500WSTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", CRYO1500WSTATUS.get(origin + "Fsub"));
    }
