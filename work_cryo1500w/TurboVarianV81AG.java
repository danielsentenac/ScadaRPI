...
public class TurboVarianV81AG extends Device {
   ...
   public TurboVarianV81AG (String _name, 
     ...
     // Turbo properties
     addDataElement( new DataElement(name, "SPEED", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd));
     addDataElement( new DataElement(name, "FSPEED", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "HR", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "PWR", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "BTEMP", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "TEMP", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "ST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "STYST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "BERR", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
     // Commands
     addDataElement( new DataElement(name, "ONOFF", DataType.TRIGGER,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "STYONOFF", DataType.TRIGGER,RegisterType.INT16,mbRegisterEnd+=1));
     // Com Status
   ...
   public void updateDeviceData() {
     ...
     d.add(getDataElement("SPEED"));
     d.add(getDataElement("FSPEED"));
     d.add(getDataElement("HR"));
     d.add(getDataElement("PWR"));
     d.add(getDataElement("BTEMP"));
     d.add(getDataElement("TEMP"));
     d.add(getDataElement("ST"));
     d.add(getDataElement("STYST"));
     d.add(getDataElement("BERR"));
     d.add(getDataElement("COMST"));
     ...
     try {
        for (int i = 0 ; i < 9 ; i++) {
           ...
           logger.finer("TurboVarianV81AG:updateDeviceData> reading from device: (" + i + " ) " + serDataR + 
           ...
           if ( !xor_checksum(serDataR.substring(1,serDataR.length() - 2)).equals(serDataR.substring(serDataR.length() - 2)) ) {
              ...
              logger.finer("TurboVarianV81AG:updateDeviceData> DATA 1 length = " + serDataR.length());
              if ( hasWarned == true ) {
                 hasWarned = false;
                 logger.info("TurboVarianV81AG:updateDeviceData> Communication with " + name + " back!");
              }
              String resultStr = "";
              logger.finer("TurboVarianV81AG:updateDeviceData> DATA 2  length = " + serDataR.length());
              ...
              switch (dataType) {
               ...
               logger.finer("TurboVarianV81AG:updateDeviceData> DATA 3 length = " + serDataR.length());
               ...
               logger.finer("TurboVarianV81AG:updateDeviceData> resultStr:" + resultStr + 
