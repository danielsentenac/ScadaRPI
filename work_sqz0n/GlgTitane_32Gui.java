...
public class GlgTitane_32Gui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PStart", SQZSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartCol", SQZSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartStr", SQZSTATUS.get(origin + "Startsub"));
       STATUS.put("PCtrl", SQZSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlCol", SQZSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlStr", SQZSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PErr", SQZSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrCol", SQZSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", SQZSTATUS.get(origin + "Errsub"));
       ...
       STATUS.put("PFILmode", SQZSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeCol", SQZSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeStr", SQZSTATUS.get(origin + "FILmodesub"));
       ...
       STATUS.put("PCTRLOPmode", SQZSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeCol", SQZSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeStr", SQZSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PAcurrentVal", SQZSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PAvoltageVal", SQZSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PSublcurrentVal", SQZSTATUS.get(origin + "SublcurrentValsub"));
       STATUS.put("PSubltimeVal", SQZSTATUS.get(origin + "SubltimeValsub"));
       STATUS.put("PSublperiodVal", SQZSTATUS.get(origin + "SublperiodValsub"));
       STATUS.put("PSublwaitVal", SQZSTATUS.get(origin + "SublwaitValsub"));
       STATUS.put("PCycleVal", SQZSTATUS.get(origin + "CycleValsub"));
       STATUS.put("PHrVal", SQZSTATUS.get(origin + "HrValsub"));
       STATUS.put("PBTempVal", SQZSTATUS.get(origin + "BTempValsub"));
    }
