...
public class GlgValveGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Valve Gui case
       STATUS.clear();
       STATUS.put("Vname", SQZSTATUS.get(origin));
       STATUS.put("Vstatus", SQZSTATUS.get(origin));
       STATUS.put("VCol", SQZSTATUS.get(origin + "Col"));
       STATUS.put("VStr", SQZSTATUS.get(origin));
