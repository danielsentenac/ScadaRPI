...
// Valves
//
put("V21","CONTROLLINO1_V21CMD");           // Type 2 (TRIGGER)
put("V22","CONTROLLINO1_V22CMD");           // Type 2 (TRIGGER)
put("V1","CONTROLLINO1_V1CMD");             // Type 2 (TRIGGER)
put("V24","CONTROLLINO2_V24CMD");           // Type 2 (TRIGGER)
put("V25","CONTROLLINO2_V25CMD");           // Type 2 (TRIGGER)
put("Vp","CONTROLLINO2_VPCMD");             // Type 2 (TRIGGER)
//put("VSpare","CONTROLLINO2_VSPARECMD");   // Type 2 (TRIGGER)
//
// Dry Pumps
//
put("DryP22","CONTROLLINO1_P22ONOFF");      // Type 2 (TRIGGER)
...
// Bypass
//
put("BypassG22","CONTROLLINO1_BYPASSONOFF");// Type 2 (TRIGGER)
put("BypassGp","CONTROLLINO2_BYPASSONOFF"); // Type 2 (TRIGGER)

//
// Fan
//
put("Fan","CONTROLLINO3_FANONOFF");// Type 2 (TRIGGER)
put("FanSpeed","CONTROLLINO3_FANSPEED"); // Type 5 (READ_AND_WRITE_STATUS)
put("Reset3","CONTROLLINO3_RESET3");// Type 2 (TRIGGER)
...
//
put("V21","CONTROLLINO1_V21ST");    // Visibility D Resource type
put("V21Col","CONTROLLINO1_V21ST"); // Color G Resource type
put("V22","CONTROLLINO1_V22ST");
put("V22Col","CONTROLLINO1_V22ST");
put("V1","CONTROLLINO1_V1ST");
put("V1Col","CONTROLLINO1_V1ST");
put("V23","CONTROLLINO1_V23ST");
put("V23Col","CONTROLLINO1_V23ST");
put("V24","CONTROLLINO2_VENTST");
put("V24Col","CONTROLLINO2_VENTST");
put("Vp","CONTROLLINO2_VPST");
put("VpCol","CONTROLLINO2_VPST");
//put("VSpare","CONTROLLINO2_VSPAREST");
//put("VSpareCol","CONTROLLINO2_VSPAREST");
put("Ve1","CONTROLLINO2_VE1ST");
put("Ve1Col","CONTROLLINO2_VE1ST");
put("Ve2","CONTROLLINO2_VE2ST");
put("Ve2Col","CONTROLLINO2_VE2ST");
...
put("Ge2","MG_PR4SST");     // D resource type (visibility)
put("Ge2Psub","MG_PR4ST");     // D resource type (visibility)
put("Ge2Val","MG_PR4");    // D resource type
put("Ge2Col","MG_PR4SST");  // G resource type
put("Ge2PColsub","MG_PR4ST");  // G resource type
put("Ge3","MG_PR5SST");     // D resource type (visibility)
put("Ge3Psub","MG_PR5ST");     // D resource type (visibility)
put("Ge3Val","MG_PR5");    // D resource type
put("Ge3Col","MG_PR5SST");  // G resource type
put("Ge3PColsub","MG_PR5ST");  // G resource type
...
// Dry Pump
//
put("DryP22","CONTROLLINO1_P22ST");
put("DryP22Col","CONTROLLINO1_P22ST");
...
// Bypass
//
put("BypassG22Val","CONTROLLINO1_BYPASSST");
put("BypassGpVal","CONTROLLINO2_BYPASSST");
...
put("AlarmComControllino1","CONTROLLINO1_COMST");
put("AlarmComControllino1Str","CONTROLLINO1_COMST");
put("AlarmComControllino1Col","CONTROLLINO1_COMST");
put("AlarmComControllino2","CONTROLLINO2_COMST");
put("AlarmComControllino2Str","CONTROLLINO2_COMST");
put("AlarmComControllino2Col","CONTROLLINO2_COMST");
put("AlarmComControllino3","CONTROLLINO3_COMST");
put("AlarmComControllino3Str","CONTROLLINO3_COMST");
put("AlarmComControllino3Col","CONTROLLINO3_COMST");
put("AirCompressed1","CONTROLLINO1_COMPRESSAIRST");
put("AirCompressed1Str","CONTROLLINO1_COMPRESSAIRST");
put("AirCompressed1Col","CONTROLLINO1_COMPRESSAIRST");
put("AirCompressed2","CONTROLLINO2_COMPRESSAIRST");
put("AirCompressed2Str","CONTROLLINO2_COMPRESSAIRST");
put("AirCompressed2Col","CONTROLLINO2_COMPRESSAIRST");
put("BypassG22","CONTROLLINO1_BYPASSST");
put("BypassG22Str","CONTROLLINO1_BYPASSST");
put("BypassG22Col","CONTROLLINO1_BYPASSST");
put("BypassGp","CONTROLLINO2_BYPASSST");
put("BypassGpStr","CONTROLLINO2_BYPASSST");
put("BypassGpCol","CONTROLLINO2_BYPASSST");
// Rack
put("FanSpeed","CONTROLLINO3_FANSPEED");
put("FanSpeedStr","CONTROLLINO3_FANSPEED");
put("FanSpeedCol","CONTROLLINO3_FANSPEED");
put("FanStatus","CONTROLLINO3_FANST");
put("FanStatusStr","CONTROLLINO3_FANST");
put("FanStatusCol","CONTROLLINO3_FANST");
put("RackTempVal","CONTROLLINO3_TEMP");
}};
...
{
put("Temp0Val","TCMUXSHIELD_TEMP0");
put("Temp1Val","TCMUXSHIELD_TEMP1");
put("Temp2Val","TCMUXSHIELD_TEMP2");
put("Temp3Val","TCMUXSHIELD_TEMP3");
put("Temp4Val","TCMUXSHIELD_TEMP4");
put("Temp5Val","TCMUXSHIELD_TEMP5");
put("Temp6Val","TCMUXSHIELD_TEMP6");
put("Temp7Val","TCMUXSHIELD_TEMP7");
put("Temp8Val","TCMUXSHIELD_TEMP8");
put("AlarmComTCMuxShield","TCMUXSHIELD_COMST");
put("AlarmComTCMuxShieldStr","TCMUXSHIELD_COMST");
put("AlarmComTCMuxShieldCol","TCMUXSHIELD_COMST");
}};
