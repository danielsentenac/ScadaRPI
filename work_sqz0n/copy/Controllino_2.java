...
public class Controllino_2 extends Device {
   ...
   public Controllino_2 (String _name,
     ...
     // Valves
     addDataElement( new DataElement(name, "VENTST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd));
     ...
     // Commands
     addDataElement( new DataElement(name, "VENTCMD", DataType.TRIGGER,RegisterType.INT16,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "VENTSOFTCMD", DataType.TRIGGER,RegisterType.INT16,mbRegisterEnd+=1));
     ...
     try {
        ...
        try {
           ...
           try {
              ...
              i2c_out.high();
              logger.finer("Controllino_2:updateDeviceData> MASTER LOCKED !!");
              Thread.sleep(100);
   ...
   public void executeCommand( DataElement e ) {
      ...
      try {
         ...
         if ( e.name.contains("VENTCMD") ) { // Valve VENT Open/Close command
         ...
         else if ( e.name.contains("VENTSOFTCMD") ) { // Valve VENTSOFT Open/Close command
