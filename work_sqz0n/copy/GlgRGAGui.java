...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", SQZSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", SQZSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", SQZSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAdegas", SQZSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", SQZSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", SQZSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", SQZSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", SQZSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", SQZSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", SQZSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", SQZSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", SQZSTATUS.get(origin + "modesub"));
       STATUS.put("RGAfilament", SQZSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", SQZSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", SQZSTATUS.get(origin + "filamentsub"));
