...
public class Main {
    ...
    // Main Title GUI
    private static final String mainTitle = "SQZ 300N Station";
    ...
    public static void main(String[] args) 
         ...
         try {
             ...
             FileHandler fileHandler = new FileHandler("SQZRack_" + LocalDate.now() + ".log");
        ...
        Device mg = new MaxiGauge("MG",
                                  ...
                                  "/dev/serial/by-id/usb-FTDI_USB-COM485_Plus4_FT3G1HD2-if00-port0",
                                  Baud._9600, 
                                  DataBits._8,  
                                  Parity.NONE, 
                                  StopBits._1, 
        ...
        Device dcu = new TurboPfeifferDCU("DCU",
                                          ...
                                          "/dev/serial/by-id/usb-FTDI_USB-COM485_Plus4_FT3G1HD2-if01-port0", 
                                          Baud._9600, 
                                          DataBits._8,  
                                          Parity.NONE, 
                                          StopBits._1, 
        ...
        Device controllino_1 = new Controllino_1("CONTROLLINO1",
        ...
        Device controllino_2 = new Controllino_2("CONTROLLINO2",
        ...
        Device controllino_3 = new Controllino_3("CONTROLLINO3",
        ...
        Device tcmuxshield = new TCMuxShield("TCMUXSHIELD",
