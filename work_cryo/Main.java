...
public class Main {
    ...
    // Main Title GUI
    private static final String mainTitle = "CRYO";
    ...
    public static void main(String[] args) 
         ...
         try {
             ...
             FileHandler fileHandler = new FileHandler("CRYORack_" + LocalDate.now() + ".log");
        ...
        Device mg = new MaxiGauge("MG",
                                  ...
                                  "/dev/serial/by-id//usb-FTDI_USB-COM232_Plus1_FT42SSFQ-if00-port0",
                                  Baud._9600, 
                                  DataBits._8,  
                                  Parity.NONE, 
                                  StopBits._1, 
        ...
        Device v81det = new TurboVarianV81AG("V81DET",
                                          mg.mbRegisterEnd, // Modbus start offset
                                         "/dev/serial/by-id//usb-FTDI_USB-COM232_Plus1_FT3F61CE-if00-port0", 
                                          Baud._9600, 
                                          DataBits._8,  
                                          Parity.NONE, 
                                          StopBits._1, 
        ...
        deviceManager.addDevice(v81det);
        /**********************************************************************************************/
        // Create TurboVarianV81AG device
        Device v81ib = new TurboVarianV81AG("V81IB",
                                          v81det.mbRegisterEnd, // Modbus start offset
                                          "/dev/serial/by-id/usb-FTDI_USB-COM232_Plus1_FT3F65FS-if00-port0", 
                                          Baud._9600, 
                                          DataBits._8,  
                                          Parity.NONE, 
                                          StopBits._1, 
        ...
        // Add TurboVarianV81AG to DeviceManager
        deviceManager.addDevice(v81ib);
        /**********************************************************************************************/
        // Create Controllino_1 device (controls Valves & Scrolls)
        Device controllino_1 = new Controllino_1("M1",
                                              v81ib.mbRegisterEnd, // Modbus start offset
                                              CONTROLLINO_1_ADDR);
        ...
        mg.doStart();
        // Start (TurboVarianV81AG) v81det device
        v81det.doStart();
        // Start (TurboVarianV81AG) v81ib device
        v81ib.doStart();
