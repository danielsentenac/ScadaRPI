...
public class GlgValveGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Valve Gui case
       STATUS.clear();
       STATUS.put("Vname", CRYOIBDETSTATUS.get(origin));
       STATUS.put("Vstatus", CRYOIBDETSTATUS.get(origin));
       STATUS.put("VCol", CRYOIBDETSTATUS.get(origin + "Col"));
       STATUS.put("VStr", CRYOIBDETSTATUS.get(origin));
