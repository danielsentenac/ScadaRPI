...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", CRYOIBDETSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", CRYOIBDETSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", CRYOIBDETSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAdegas", CRYOIBDETSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", CRYOIBDETSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", CRYOIBDETSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", CRYOIBDETSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", CRYOIBDETSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", CRYOIBDETSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", CRYOIBDETSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", CRYOIBDETSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", CRYOIBDETSTATUS.get(origin + "modesub"));
       STATUS.put("RGAfilament", CRYOIBDETSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", CRYOIBDETSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", CRYOIBDETSTATUS.get(origin + "filamentsub"));
