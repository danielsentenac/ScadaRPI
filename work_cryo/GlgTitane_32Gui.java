...
public class GlgTitane_32Gui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PStart", CRYOIBDETSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartCol", CRYOIBDETSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartStr", CRYOIBDETSTATUS.get(origin + "Startsub"));
       STATUS.put("PCtrl", CRYOIBDETSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlCol", CRYOIBDETSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlStr", CRYOIBDETSTATUS.get(origin + "Ctrlsub"));
       ...
       STATUS.put("PREmode", CRYOIBDETSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeCol", CRYOIBDETSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeStr", CRYOIBDETSTATUS.get(origin + "REmodesub"));
       STATUS.put("PFILmode", CRYOIBDETSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeCol", CRYOIBDETSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeStr", CRYOIBDETSTATUS.get(origin + "FILmodesub"));
       STATUS.put("POPmode", CRYOIBDETSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeCol", CRYOIBDETSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeStr", CRYOIBDETSTATUS.get(origin + "OPmodesub"));
       STATUS.put("PCTRLOPmode", CRYOIBDETSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeCol", CRYOIBDETSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeStr", CRYOIBDETSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PAcurrentVal", CRYOIBDETSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PAvoltageVal", CRYOIBDETSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PSublcurrentVal", CRYOIBDETSTATUS.get(origin + "SublcurrentValsub"));
       STATUS.put("PSubltimeVal", CRYOIBDETSTATUS.get(origin + "SubltimeValsub"));
       STATUS.put("PSublperiodVal", CRYOIBDETSTATUS.get(origin + "SublperiodValsub"));
       STATUS.put("PSublwaitVal", CRYOIBDETSTATUS.get(origin + "SublwaitValsub"));
       STATUS.put("PCycleVal", CRYOIBDETSTATUS.get(origin + "CycleValsub"));
       STATUS.put("PHrVal", CRYOIBDETSTATUS.get(origin + "HrValsub"));
