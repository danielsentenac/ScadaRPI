...
String mainDrawing = "CRYOIBDET.g";

/***********************************************************************/
Hashtable<String, String> CRYOIBDETCMD = new Hashtable<String, String>(){
...
// Gauges
//
put("G22Det","MG_PR1ONOFF");         // Type 2 (TRIGGER)
put("G22Ib","MG_PR2ONOFF");          // Type 2 (TRIGGER)
//
// Valves
//
put("V21Det","M1_V21DETCMD");        // Type 2 (TRIGGER)
put("V22Det","M1_V22DETCMD");        // Type 2 (TRIGGER)
put("V21Ib","M1_V21IBCMD");          // Type 2 (TRIGGER)
put("V22Ib","M1_V22IBCMD");          // Type 2 (TRIGGER)

//
// Dry Pumps
//
put("DryP22Det","M1_P22DETONOFF");   // Type 2 (TRIGGER)
put("DryP22Ib","M1_P22IBONOFF");     // Type 2 (TRIGGER)

//
// Turbo Pumps
//
put("TurboP21Det","V81DET_P21ONOFF");             // Type 2 (TRIGGER)
put("TurboP21DetSty","V81DET_P21STYONOFF");       // Type 2 (TRIGGER)
put("TurboP21Ib","V81IB_P21ONOFF");             // Type 2 (TRIGGER)
put("TurboP21IbSty","V81IB_P21STYONOFF");       // Type 2 (TRIGGER)

}};
/***********************************************************************/
Hashtable<String, String> CRYOIBDETSTATUS = new Hashtable<String, String>(){
...
//
//put("V21Det","M1_V21DETST");    // Visibility D Resource type
//put("V21DetCol","M1_V21DETST"); // Color G Resource type
put("V22Det","M1_V22DETST");
put("V22DetCol","M1_V22DETST");
//put("V21Ib","M1_V21IBST");    // Visibility D Resource type
//put("V21IbCol","M1_V21IBST"); // Color G Resource type
put("V22Ib","M1_V22IBST");
put("V22IbCol","M1_V22IBST");

//
// Gauges (Maxigauge device)
//
put("G22Det","MG_PR1SST");     // D resource type (visibility)
put("G22DetPsub","MG_PR1ST");     // D resource type (visibility)
put("G22DetVal","MG_PR1");    // D resource type
put("G22DetCol","MG_PR1SST");  // G resource type
put("G22DetPColsub","MG_PR1ST");  // G resource type
put("G22Ib","MG_PR2SST");     // D resource type (visibility)
put("G22IbPsub","MG_PR2ST");     // D resource type (visibility)
put("G22IbVal","MG_PR2");    // D resource type
put("G22IbCol","MG_PR2SST");  // G resource type
put("G22IbPColsub","MG_PR2ST");  // G resource type

//
// Dry Pump
//
put("DryP22Det","M1_P22DETST");
put("DryP22DetCol","M1_P22DETST");
put("DryP22Ib","M1_P22IBST");
put("DryP22IbCol","M1_P22IBST");
//
// Turbo Pumps
//
put("TurboP21Det","V81DET_P21ST");
put("TurboP21DetCol","V81DET_P21ST");
put("TurboP21DetSpeedVal","V81DET_P21SPEED");
put("TurboP21DetPowerVal","V81DET_P21PWR");
put("TurboP21DetStysub","V81DET_P21STYST");
put("TurboP21DetTempsub","NULL");
put("TurboP21DetBTempsub","NULL");
put("TurboP21DetErrsub","V81DET_P21BERR");
put("TurboP21DetTempValsub","V81DET_P21TEMP");
put("TurboP21DetBTempValsub","V81DET_P21BTEMP");
put("TurboP21DetSpeedValsub","V81DET_P21SPEED");
put("TurboP21DetPowerValsub","V81DET_P21PWR");
put("TurboP21DetFspeedValsub","V81DET_P21FSPEED");
put("TurboP21DetHoursValsub","V81DET_P21HR");

put("TurboP21Ib","V81IB_P21ST");
put("TurboP21IbCol","V81IB_P21ST");
put("TurboP21IbSpeedVal","V81IB_P21SPEED");
put("TurboP21IbPowerVal","V81IB_P21PWR");
put("TurboP21IbStysub","V81IB_P21STYST");
put("TurboP21IbTempsub","NULL");
put("TurboP21IbBTempsub","NULL");
put("TurboP21IbErrsub","V81IB_P21BERR");
put("TurboP21IbTempValsub","V81IB_P21TEMP");
put("TurboP21IbBTempValsub","V81IB_P21BTEMP");
put("TurboP21IbSpeedValsub","V81IB_P21SPEED");
put("TurboP21IbPowerValsub","V81IB_P21PWR");
put("TurboP21IbFspeedValsub","V81IB_P21FSPEED");
put("TurboP21IbHoursValsub","V81IB_P21HR");
...
//
/***********************************************************************/
Hashtable<String, String> CryoIbDetStatusDetails = new Hashtable<String, String>(){
...
put("AlarmComTurboP21Det","V81DET_P21COMST");
put("AlarmComTurboP21DetStr","V81DET_P21COMST");
put("AlarmComTurboP21DetCol","V81DET_P21COMST");
put("AlarmComTurboP21Ib","V81IB_P21COMST");
put("AlarmComTurboP21IbStr","V81IB_P21COMST");
put("AlarmComTurboP21IbCol","V81IB_P21COMST");
