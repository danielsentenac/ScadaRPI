...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", CRYOIBDETSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", CRYOIBDETSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", CRYOIBDETSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", CRYOIBDETSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", CRYOIBDETSTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", CRYOIBDETSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", CRYOIBDETSTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", CRYOIBDETSTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", CRYOIBDETSTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", CRYOIBDETSTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", CRYOIBDETSTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", CRYOIBDETSTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", CRYOIBDETSTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", CRYOIBDETSTATUS.get(origin + "ScurrentValsub"));
    }
