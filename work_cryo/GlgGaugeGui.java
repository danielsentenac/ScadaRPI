...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", CRYOIBDETSTATUS.get(origin));
       STATUS.put("Gestatus", CRYOIBDETSTATUS.get(origin));
       STATUS.put("GePstatus", CRYOIBDETSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", CRYOIBDETSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", CRYOIBDETSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", CRYOIBDETSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", CRYOIBDETSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", CRYOIBDETSTATUS.get(origin));
       STATUS.put("GePStr", CRYOIBDETSTATUS.get(origin + "Psub"));
    }
