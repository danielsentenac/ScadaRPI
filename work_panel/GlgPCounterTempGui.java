/*
 * This Class is used for PCounterTemp GUI using Glg Toolkit
 */
...
public class GlgPCounterTempGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgPCounterTempGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // PCounterTemp display
          glg_bean.SetDrawingFile("PCounterTemp.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // PCounterTemp Gui case
       STATUS.clear();
       STATUS.putAll(PCounterTemp);
    }
