    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          String serData1[4] = {"0010030902=?107\r","0010002302=?100\r","0010001002=?096\r","0010000202=?097\r"};
          String serData2[4] = {"","","",""};
          Serial.print(serData1[3]);
          serData2[3] = Serial.readString();
          int csum = 0; // Calculate checksum
          for (int k = 0 ; k < serData2[3].length() - 4; k++)
           csum+= serData2[3][k];
          int csumd = serData2[3].substring(serData2[3].length() - 4, serData2[3].length() - 1).toInt();
          ...
          for (int i = 3 ; i < 4 ; i++) {
           ...
           client.println("</br>");
           client.print(serData2[i].length());
           client.println("</br>");
            client.print(csum%256);
           client.println("</br>");
            client.print(csumd);
           client.println("</br>");
           client.print(serData2[i].substring(5, 8));
           client.println("</br>"); 
           client.print(serData1[i].substring(5, 8));
           client.println("</br>"); 
           client.print(serData2[i].substring(10, 16));
           client.println("</br>"); 
          }
