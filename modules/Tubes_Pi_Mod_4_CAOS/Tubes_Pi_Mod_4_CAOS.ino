/*
 ...
 CAOS module M4: chamber 2 (EST END) venting module.
 Identical to Tubes_Pi_Mod_2 except for the I2C slave address (0x0B).
 The VSPARE valve slot (R6/R7 cmd, A9 status) is actively used as VREM.
 */
