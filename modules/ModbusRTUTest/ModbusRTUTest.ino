...
const byte ip[] = { 192, 168, 224, 177 }; // Arduino-16 has this IP
...
SoftwareSerial RS485Serial(10, 11); // RX, TX for Leonardo

// digital pins
#define RS485_TRANSEIVER_STATUS  3  // RS485 TRANSEIVER STATE

// Modbus addresses limits
#define NB_HOLDING_REGISTERS 60
#define MODBUS_START_ADDR 0
#define MODBUS_END_ADDR 58
#define ARD_RESET_ADDR MODBUS_END_ADDR+1
...
void loop() {
 ...
 // Ethernet.maintain();
  ...
  FloatUint16 mbFloatValue;
  
  typedef union {
      uint32_t uint32value;
      uint16_t value[2];
  } Uint32Uint16;
  Uint32Uint16 mbIntValue;
  ...
  for (int i = 0 ; i < 6 ; i++) {
    ...
    serData6 = RS485Serial.readString();
...
{    
  ...
  for (int i = MODBUS_START_ADDR; i < MODBUS_END_ADDR; i++)
