...
#define LN2TANKVALVE_WE_RELAY CONTROLLINO_R5  // NE LN2 TANK VALVE RELAY
...
{    
  ...
  digitalWrite(LN2TANKVALVE_WE_RELAY,LOW);                          // Set LN2TANKVALVE_WE_RELAY to LOW
  pinMode(LN2TANKVALVE_WE_RELAY,OUTPUT) ;                           // sets the digital relay pin as output for LN2 Tank Valve
  holdingRegisters[LN2TANKVALVE_WE_ADDR] = 0x01;    // Initialize RELAY ADDRESS to OPEN
...
{    
  ...
  /***********************************************************************************************************/
  if (holdingRegisters[LN2TANKVALVE_WE_ADDR] == 0x02) {
     digitalWrite(LN2TANKVALVE_WE_RELAY,HIGH); // OPEN RELAY (CLOSE VALVE)
  }
  else if (holdingRegisters[LN2TANKVALVE_WE_ADDR] == 0x01) {
     digitalWrite(LN2TANKVALVE_WE_RELAY,LOW); // CLOSE RELAY (OPEN VALVE)
  } 
  /***********************************************************************************************************/
