...
IPAddress ip[] = { 192, 168, 224, 157 }; // Controllino-5 has this IP
...
SoftwareSerial VARIANSerial(CONTROLLINO_D10, CONTROLLINO_PIN_HEADER_DIGITAL_OUT_14); // RX, TX for Controllino
...
#define XGS_START_ADDR VARIAN_END_ADDR+1
