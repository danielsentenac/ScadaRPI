...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x10, 0x67, 0xAB };
IPAddress ip( 192, 168, 224, 163 ); // Controllino-11 has this IP
...
#define MIDIVAC_START_ADDR VA2_STATUS_ADDR+1
#define MIDIVAC_HV1_START_ADDR MIDIVAC_START_ADDR
#define MIDIVAC_HV1_ONOFF_ADDR MIDIVAC_HV1_START_ADDR+19
#define MIDIVAC_HV1_OP_ADDR MIDIVAC_HV1_START_ADDR+20
#define MIDIVAC_HV1_VOLT_ADDR MIDIVAC_HV1_START_ADDR+21
#define MIDIVAC_HV1_PARAM_ADDR MIDIVAC_HV2_START_ADDR+22
#define MIDIVAC_HV1_PRTCURRVAL_ADDR MIDIVAC_HV1_START_ADDR+23
#define MIDIVAC_HV1_MAXCURRVAL_ADDR MIDIVAC_HV1_START_ADDR+24
#define MIDIVAC_HV1_MAXVOLTVAL_ADDR MIDIVAC_HV1_START_ADDR+25
#define MIDIVAC_HV1_MAXWVAL_ADDR MIDIVAC_HV1_START_ADDR+26
#define MIDIVAC_HV1_1STEPVOLTVAL_ADDR MIDIVAC_HV1_START_ADDR+27
#define MIDIVAC_HV1_2STEPVOLTVAL_ADDR MIDIVAC_HV1_START_ADDR+28
#define MIDIVAC_HV1_1STEPCURRVAL_ADDR MIDIVAC_HV1_START_ADDR+29
#define MIDIVAC_HV1_2STEPCURRVAL_ADDR MIDIVAC_HV1_START_ADDR+31
#define MIDIVAC_HV1_END_ADDR MIDIVAC_HV1_2STEPCURRVAL_ADDR+1
#define MIDIVAC_HV2_START_ADDR MIDIVAC_HV1_END_ADDR+1
#define MIDIVAC_HV2_ONOFF_ADDR MIDIVAC_HV2_START_ADDR+19
#define MIDIVAC_HV2_OP_ADDR MIDIVAC_HV2_START_ADDR+20
#define MIDIVAC_HV2_VOLT_ADDR MIDIVAC_HV2_START_ADDR+21
#define MIDIVAC_HV2_PARAM_ADDR MIDIVAC_HV2_START_ADDR+22
#define MIDIVAC_HV2_PRTCURRVAL_ADDR MIDIVAC_HV2_START_ADDR+23
#define MIDIVAC_HV2_MAXCURRVAL_ADDR MIDIVAC_HV2_START_ADDR+24
#define MIDIVAC_HV2_MAXVOLTVAL_ADDR MIDIVAC_HV2_START_ADDR+25
#define MIDIVAC_HV2_MAXWVAL_ADDR MIDIVAC_HV2_START_ADDR+26
#define MIDIVAC_HV2_1STEPVOLTVAL_ADDR MIDIVAC_HV2_START_ADDR+27
#define MIDIVAC_HV2_2STEPVOLTVAL_ADDR MIDIVAC_HV2_START_ADDR+28
#define MIDIVAC_HV2_1STEPCURRVAL_ADDR MIDIVAC_HV2_START_ADDR+29
#define MIDIVAC_HV2_2STEPCURRVAL_ADDR MIDIVAC_HV2_START_ADDR+31
#define MIDIVAC_HV2_END_ADDR MIDIVAC_HV2_2STEPCURRVAL_ADDR+1
#define MIDIVAC_END_ADDR MIDIVAC_HV2_END_ADDR+1
...
/*#define VARIAN_START_ADDR MG_END_ADDR+11
#define VARIAN_STARTSTOP_ADDR 18 //(VARIAN ON/OFF Command)
#define VARIAN_LOWSPEED_ADDR 19  //(VARIAN LOWSPEED Command)
#define VARIAN_END_ADDR 20*/
#define XGS_START_ADDR MIDIVAC_END_ADDR+1
#define XGS_EMULT1_ADDR 82   //(XGS EMULT 1 ON/OFF Command)
#define XGS_EMULT2_ADDR 83   //(XGS EMULT 2 ON/OFF Command)
#define XGS_DEGAS_ADDR 84   //(XGS DEGAS ON/OFF Command)
#define XGS_END_ADDR 85 
...
void setup() {
 ...
 /* pinMode(RS485_TRANSEaIVER_STATUS, OUTPUT);
  ...
  //Spare2Serial.begin(9600);  // used for the MIDIVAC DUAL CONTROLLER
...
void loop() {
 /***********************************************************************************************************/
  ...
  // Communicate with Master (send/receive data)
    SendReceiveMaster();
     ...
     delay(100);
     Spare1Serial.listen();
     Spare1Serial.print(serData5);
     Serial.println(serData5);
     delay(100);
     serData6 = Spare1Serial.readString();
 ...
 /***********************************************************************************************************/
 /*  Serial Midivac Dual Controller HV1 data / Update Modbus register values */
 /**********************************************************************************************************/
 int curaddr = MIDIVAC_HV1_START_ADDR;
  for (int i = 0; i < 15; i++) {
  // Communicate with Master (send/receive data)
    SendReceiveMaster();
    UpdateRegisters();
    UpdateHV1Registers();
     ...
     switch (i) {
       case 0:
       serData5 = "\x81\x30\x34\x41\x30\x31\x3F"; // HV1 status
       serData5+=xor_checksum(serData5);
         break;
       case 1:
       serData5 = "\x81\x30\x34\x43\x30\x31\x3F"; // HV1 Operating mode (Started/Protect)
       serData5+=xor_checksum(serData5);
         break;
       case 2:
       serData5 = "\x81\x30\x34\x42\x30\x31\x3F"; // HV1 Voltage mode (Fixed/Step)
       serData5+=xor_checksum(serData5);
         break;
       case 3:
       serData5 = "\x81\x30\x34\x5A\x30\x30\x3F"; // local/remote status
       serData5+=xor_checksum(serData5);
         break;
       case 4:
       serData5 = "\x81\x30\x34\x54\x30\x31\x3F"; // HV1 absorbed current
       serData5+=xor_checksum(serData5);
         break;
       case 5:
       serData5 = "\x81\x30\x34\x4B\x30\x31\x3F"; // HV1 I Protect
       serData5+=xor_checksum(serData5);
         break;
       case 6:
       serData5 = "\x81\x30\x34\x53\x30\x31\x3F"; // HV1 absorbed voltage
       serData5+=xor_checksum(serData5);
         break;
       case 7:
       serData5 = "\x81\x30\x34\x55\x30\x31\x3F"; // HV1 pressure measured
       serData5+=xor_checksum(serData5);
         break;
       case 8:
       serData5 = "\x81\x30\x34\x49\x30\x31\x3F"; // HV1 IMax
       serData5+=xor_checksum(serData5);
         break;
       case 9:
       serData5 = "\x81\x30\x34\x48\x30\x31\x3F"; // HV1 VMax
       serData5+=xor_checksum(serData5);
         break;
       case 10:
       serData5 = "\x81\x30\x34\x4A\x30\x31\x3F"; // HV1 PMax
       serData5+=xor_checksum(serData5);
         break;
       case 11:
       serData5 = "\x81\x30\x34\x4C\x30\x31\x3F"; // HV1 VStep1
       serData5+=xor_checksum(serData5);
         break;
       case 12:
       serData5 = "\x81\x30\x34\x4E\x30\x31\x3F"; // HV1 VStep2
       serData5+=xor_checksum(serData5);
         break;
       case 13:
       serData5 = "\x81\x30\x34\x4D\x30\x31\x3F"; // HV1 IStep1
       serData5+=xor_checksum(serData5);
         break;
       case 14:
       serData5 = "\x81\x30\x34\x4F\x30\x31\x3F"; // HV1 IStep2
       serData5+=xor_checksum(serData5);
         break;
     }
     //delay(100);
     ...
     Serial.println(serData6); 
     if (serData6 == "") {// Com Status Error
     for (int j = MIDIVAC_HV1_START_ADDR; j < MIDIVAC_HV1_END_ADDR; j++)
        holdingRegisters[j] = 0xFF;
      holdingRegisters[MIDIVAC_END_ADDR] = 0x01;
     }
     else  {
      holdingRegisters[MIDIVAC_END_ADDR] = 0x00;
      Serial.print("serData6.length()=");Serial.println(serData6.length());
       int ndata;
       sscanf(serData6.substring(1,3).c_str(),"%d",&ndata);
       ndata -= 3; // Keep only response data
       Serial.print("ndata=");Serial.println(ndata);
       String resultStr= serData6.substring(6,6+ndata).c_str();
       Serial.print(i);Serial.print(":resultStr=");Serial.print(resultStr);Serial.print(" reg:");Serial.println(curaddr);
       if (i != 4 && i != 7 && i != 13 && i != 14) {
        if (resultStr.substring(0,1) == "!") { // Protocol Error; do nothing
          curaddr++;
          continue;
        } 
        uint16_t result = resultStr.toInt();
        holdingRegisters[curaddr++] = result;
       }
       else  {
         if (resultStr.substring(0,1) == "!") { // Protocol Error; do nothing
         ...
         mbfValue.fvalue = strtod(resultStr.c_str(), NULL);
         Serial.println(mbfValue.fvalue);
         holdingRegisters[curaddr++] = mbfValue.value[0];
         holdingRegisters[curaddr++] = mbfValue.value[1];
       }    
 ...
 /***********************************************************************************************************/
 /*  Serial Midivac Dual Controller HV2 data / Update Modbus register values */
 /***********************************************************************************************************/
  curaddr = MIDIVAC_HV2_START_ADDR;
  for (int i = 0; i < 15; i++) {
  // Communicate with Master (send/receive data)
    SendReceiveMaster();
    UpdateRegisters();
    UpdateHV2Registers();
     ...
     switch (i) {
       case 0:
       serData5 = "\x81\x30\x34\x41\x30\x32\x3F"; // HV2 status
       serData5+=xor_checksum(serData5);
         break;
       case 1:
       serData5 = "\x81\x30\x34\x43\x30\x32\x3F"; // HV2 Operating mode (Started/Protect)
       serData5+=xor_checksum(serData5);
         break;
       case 2:
       serData5 = "\x81\x30\x34\x42\x30\x32\x3F"; // HV2 Voltage mode (Fixed/Step)
       serData5+=xor_checksum(serData5);
         break;
       case 3:
       serData5 = "\x81\x30\x34\x5A\x30\x30\x3F"; // local/remote status
       serData5+=xor_checksum(serData5);
         break;
       case 4:
       serData5 = "\x81\x30\x34\x54\x30\x32\x3F"; // HV2 absorbed current
       serData5+=xor_checksum(serData5);
         break;
       case 5:
       serData5 = "\x81\x30\x34\x4B\x30\x32\x3F"; // HV2 I Protect
       serData5+=xor_checksum(serData5);
         break;
       case 6:
       serData5 = "\x81\x30\x34\x53\x30\x32\x3F"; // HV2 absorbed voltage
       serData5+=xor_checksum(serData5);
         break;
       case 7:
       serData5 = "\x81\x30\x34\x55\x30\x32\x3F"; // HV2 pressure measured
       serData5+=xor_checksum(serData5);
         break;
       case 8:
       serData5 = "\x81\x30\x34\x49\x30\x32\x3F"; // HV2 IMax
       serData5+=xor_checksum(serData5);
         break;
       case 9:
       serData5 = "\x81\x30\x34\x48\x30\x32\x3F"; // HV2 VMax
       serData5+=xor_checksum(serData5);
         break;
       case 10:
       serData5 = "\x81\x30\x34\x4A\x30\x32\x3F"; // HV2 PMax
       serData5+=xor_checksum(serData5);
         break;
       case 11:
       serData5 = "\x81\x30\x34\x4C\x30\x32\x3F"; // HV2 VStep1
       serData5+=xor_checksum(serData5);
         break;
       case 12:
       serData5 = "\x81\x30\x34\x4E\x30\x32\x3F"; // HV2 VStep2
       serData5+=xor_checksum(serData5);
         break;
       case 13:
       serData5 = "\x81\x30\x34\x4D\x30\x32\x3F"; // HV2 IStep1
       serData5+=xor_checksum(serData5);
         break;
       case 14:
       serData5 = "\x81\x30\x34\x4F\x30\x32\x3F"; // HV2 IStep2
       serData5+=xor_checksum(serData5);
         break;
     }
     //delay(100);
     ...
     Serial.println(serData6); 
     if (serData6 == "") {// Com Status Error
     for (int j = MIDIVAC_HV2_START_ADDR; j < MIDIVAC_HV2_END_ADDR; j++)
        holdingRegisters[j] = 0xFF;
      holdingRegisters[MIDIVAC_END_ADDR] = 0x01;
     }
     else {
  ...
  for (int i = 0 ; i < 4 ; i++) {
    ...
    if (serData8 == "") {// Com Status Error
      ...
      if ( i == 0 ) { // Pressure float
        ...
        mbfValue.fvalue = prval.toFloat();
        Serial.print("register 1:"); Serial.println(curaddr);
        holdingRegisters[curaddr++] = mbfValue.value[0]; 
        Serial.print("register 2:"); Serial.println(curaddr);
        holdingRegisters[curaddr++] = mbfValue.value[1];
 ...
 *  V21 Valve Case
 */
  // Reset V21_CLOSE_VALVE
  if (digitalRead(V21_CLOSE_VALVE) == LOW && V21_RESET == true) {
    if ( millis() - V21time > reset_wait) {
       digitalWrite(V21_CLOSE_VALVE,HIGH);  // RESET CLOSE VALVE
       holdingRegisters[V21_VALVE_ADDR] = 0x00; // RESET register
       V21_RESET = false;  
    }
  }
  // Reset V21_OPEN_VALVE
  if (digitalRead(V21_OPEN_VALVE) == HIGH && V21_RESET == true) {
    if ( millis() - V21time > reset_wait) {
       digitalWrite(V21_OPEN_VALVE,LOW);   // RESET OPEN VALVE
       holdingRegisters[V21_VALVE_ADDR] = 0x00; // RESET register
       V21_RESET = false;
 ...
 * V22 Valve case
 */
  // Reset V22_CLOSE_VALVE
  if (digitalRead(V22_CLOSE_VALVE) == LOW && V22_RESET == true) {
    if ( millis() - V22time > reset_wait) {
       digitalWrite(V22_CLOSE_VALVE,HIGH);  // RESET CLOSE VALVE
       holdingRegisters[V22_VALVE_ADDR] = 0x00; // RESET register
       V22_RESET = false;  
    }
  }
  // Reset V22_OPEN_VALVE
  if (digitalRead(V22_OPEN_VALVE) == HIGH && V22_RESET == true) {
    if ( millis() - V22time > reset_wait) {
       digitalWrite(V22_OPEN_VALVE,LOW);   // RESET OPEN VALVE
       holdingRegisters[V22_VALVE_ADDR] = 0x00; // RESET register
       V22_RESET = false;
       // Now we will check that Valve has effectively closed after some time
       V22time = millis();
...
void UpdateRegisters ()
{
  ...
  /***********************************************************************************************************/
  if (holdingRegisters[V21_VALVE_ADDR] == 0x02 && V21_RESET == false) {
     digitalWrite(V21_CLOSE_VALVE,LOW); // CLOSE VALVE
     V21time = millis();
     V21_RESET = true;
  }        
  else if (holdingRegisters[V21_VALVE_ADDR] == 0x01 && V21_RESET == false) {
  ...
  /***********************************************************************************************************/
  if (holdingRegisters[V22_VALVE_ADDR] == 0x02 && V22_RESET == false) {
     digitalWrite(V22_CLOSE_VALVE,LOW); // CLOSE VALVE
     V22time = millis();
     V22_RESET = true;
  }
  else if (holdingRegisters[V22_VALVE_ADDR] == 0x01 && V22_RESET == false) {
 ...
 /* Serial.print("PIN4_VALVE=");Serial.print(digitalRead(PIN4_VALVE));Serial.print(" HIGH=");
  ...
  if (digitalRead(V21_OPEN_STATUS) == HIGH && digitalRead(V21_CLOSE_STATUS) == LOW) 
     ...
     if (holdingRegisters[V21_STATUS_ADDR] == 0x01 || holdingRegisters[V21_STATUS_ADDR] == 0x00) {
      Serial.println("Valve modbus Status closed RESET RELAY");
        // reset close command
        digitalWrite(V21_CLOSE_VALVE,LOW); // CLOSE VALVE
        V21_RESET = true;
        V21time = millis();
  ...
  if (digitalRead(V22_OPEN_STATUS) == HIGH && digitalRead(V22_CLOSE_STATUS) == LOW)
     ...
     if (holdingRegisters[V22_STATUS_ADDR] == 0x01 || holdingRegisters[V22_STATUS_ADDR] == 0x00) {
        // reset close command
        digitalWrite(V22_CLOSE_VALVE,LOW); // CLOSE VALVE
        V22_RESET = true;
        V22time = millis();
  ...
  */
  ...
  /***********************************************************************************************************/
  /* Update MidiVac Dual (Ionic Pump) COMMAND */
  /***********************************************************************************************************/
void UpdateHV1Registers ()
{
  if ( holdingRegisters[MIDIVAC_END_ADDR] == 0x00 ) {
      String cmd="";
      /**********HV1**************/
      /***************************/
      /***************************/
      if (holdingRegisters[MIDIVAC_HV1_ONOFF_ADDR] == 0x01) {// HV1 Switch ON CMD
        cmd = "\x81\x30\x34\x41\x30\x31\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        holdingRegisters[MIDIVAC_HV1_ONOFF_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV1_ONOFF_ADDR] == 0x02) {// HV1 Switch OFF CMD
        cmd = "\x81\x30\x34\x41\x30\x31\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        holdingRegisters[MIDIVAC_HV1_ONOFF_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_OP_ADDR] == 0x01) {// HV1 Started Operating Mode CMD
        cmd = "\x81\x30\x34\x43\x30\x31\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_OP_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV1_OP_ADDR] == 0x02) {// HV1 Protected Operating Mode CMD
        cmd = "\x81\x30\x34\x43\x30\x31\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_OP_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_VOLT_ADDR] == 0x01) {// HV1 Fixed Voltage CMD
        cmd = "\x81\x30\x34\x42\x30\x31\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_VOLT_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV1_VOLT_ADDR] == 0x02) {// HV1 Stepped Voltage Mode CMD
        cmd = "\x81\x30\x34\x42\x30\x31\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_VOLT_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 1) {// HV1 Set Protected Current
        String data =  String(holdingRegisters[MIDIVAC_HV1_PRTCURRVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4B\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 2) {// HV1 Set Max Current
        String data =  String(holdingRegisters[MIDIVAC_HV1_MAXCURRVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x49\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 4) {// HV1 Set Max Voltage
        String data =  String(holdingRegisters[MIDIVAC_HV1_MAXVOLTVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x48\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 8) {// HV1 Set Max Power
        String data =  String(holdingRegisters[MIDIVAC_HV1_MAXWVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4A\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 16) {// HV1 Set Step1 Voltage
        String data = String(holdingRegisters[MIDIVAC_HV1_1STEPVOLTVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;  
        cmd = "\x81\x30\x38\x4C\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 32) {// HV1 Set Step2 Voltage
        String data = String(holdingRegisters[MIDIVAC_HV1_2STEPVOLTVAL_ADDR],HEX);
        while (data.length() < 5) // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4E\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 64) {// HV1 Set Step1 Current
        String data;
        float value = holdingRegisters[MIDIVAC_HV1_1STEPCURRVAL_ADDR];
        sprintf(data.c_str(),"%7.1E",value); // Convert to 7 bytes scientific notation string
        cmd = "\x81\x30\x40\x4D\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV1_PARAM_ADDR] == 128) {// HV1 Set Step2 Current
        String data;
        float value = holdingRegisters[MIDIVAC_HV1_2STEPCURRVAL_ADDR];
        sprintf(data.c_str(),"%7.1E",value); // Convert to 7 bytes scientific notation string
        cmd = "\x81\x30\x40\x4F\x30\x31" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
...
void UpdateHV2Registers ()
{
   if ( holdingRegisters[MIDIVAC_END_ADDR] == 0x00 ) {
      ...
      /***************************/
      /***************************/
      if (holdingRegisters[MIDIVAC_HV2_ONOFF_ADDR] == 0x01) {// HV2 Switch ON CMD
        cmd = "\x81\x30\x34\x41\x30\x32\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_ONOFF_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV2_ONOFF_ADDR] == 0x02) {// HV2 Switch OFF CMD
        cmd = "\x81\x30\x34\x41\x30\x32\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_ONOFF_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_ONOFF_ADDR] == 0x01) {// HV2 Started Operating Mode CMD
        cmd = "\x81\x30\x34\x43\x30\x32\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_OP_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV2_OP_ADDR] == 0x02) {// HV2 Protected Operating Mode CMD
        cmd = "\x81\x30\x34\x43\x30\x32\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_OP_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_VOLT_ADDR] == 0x01) {// HV2 Fixed Voltage CMD
        cmd = "\x81\x30\x34\x42\x30\x32\x30";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_VOLT_ADDR] = 0x00; // RESET
      }
      else if (holdingRegisters[MIDIVAC_HV2_VOLT_ADDR] == 0x02) {// HV2 Stepped Voltage Mode CMD
        cmd = "\x81\x30\x34\x42\x30\x32\x31";
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_VOLT_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 1) {// HV2 Set Protected Current
        String data =  String(holdingRegisters[MIDIVAC_HV2_PRTCURRVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4B\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 2) {// HV2 Set Max Current
        String data =  String(holdingRegisters[MIDIVAC_HV2_MAXCURRVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x49\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 4) {// HV2 Set Max Voltage
        String data =  String(holdingRegisters[MIDIVAC_HV2_MAXVOLTVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x48\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 8) {// HV2 Set Max Power
        String data =  String(holdingRegisters[MIDIVAC_HV2_MAXWVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4A\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 16) {// HV2 Set Step1 Voltage
        String data = String(holdingRegisters[MIDIVAC_HV2_1STEPVOLTVAL_ADDR],HEX);
        while (data.length() < 5)  // Convert to 5 bytes integer notation string
          data = "0" + data;   
        cmd = "\x81\x30\x38\x4A\x30\x32" + data;
        cmd+=xor_checksum(cmd);
      ...
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 32) {// HV2 Set Step2 Voltage
        String data = String(holdingRegisters[MIDIVAC_HV2_2STEPVOLTVAL_ADDR],HEX);
        while (data.length() < 5) // Convert to 5 bytes integer notation string
          data = "0" + data;
        cmd = "\x81\x30\x38\x4E\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 64) {// HV2 Set Step1 Current
        String data;
        float value = holdingRegisters[MIDIVAC_HV2_1STEPCURRVAL_ADDR];
        sprintf(data.c_str(),"%7.1E",value); // Convert to 7 bytes scientific notation string
        cmd = "\x81\x30\x40\x4D\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
        
        holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] = 0x00; // RESET
      }
      if (holdingRegisters[MIDIVAC_HV2_PARAM_ADDR] == 128) {// HV2 Set Step2 Current
        String data;
        float value = holdingRegisters[MIDIVAC_HV2_2STEPCURRVAL_ADDR];
        sprintf(data.c_str(),"%7.1E",value); // Convert to 7 bytes scientific notation string
        cmd = "\x81\x30\x40\x4F\x30\x32" + data;
        cmd+=xor_checksum(cmd);
        SendCommand(cmd);
...
{
  // Send the command
  Serial.println("Send the command to Midivac:" + cmd);
  Spare1Serial.listen();
  Spare1Serial.print(cmd);
  cmd = Spare1Serial.readString();
  Serial.println("Receive answer from Midivac:" + cmd);
}
