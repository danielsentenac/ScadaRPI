...
public class GlgTurboPfeifferDCUGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PErr", TUBE1500WSTATUS.get(origin));
       STATUS.put("PErrCol", TUBE1500WSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", TUBE1500WSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrVal", TUBE1500WSTATUS.get(origin + "ErrValsub"));
       STATUS.put("PSty", TUBE1500WSTATUS.get(origin));
       STATUS.put("PStyCol", TUBE1500WSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", TUBE1500WSTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", TUBE1500WSTATUS.get(origin));
       STATUS.put("PTempCol", TUBE1500WSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", TUBE1500WSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempVal", TUBE1500WSTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTemp", TUBE1500WSTATUS.get(origin));
       STATUS.put("PBTempCol", TUBE1500WSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", TUBE1500WSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempVal", TUBE1500WSTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", TUBE1500WSTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", TUBE1500WSTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", TUBE1500WSTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", TUBE1500WSTATUS.get(origin + "HoursValsub"));      
    }
