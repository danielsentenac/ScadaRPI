...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", TUBE1500WSTATUS.get(origin));
       STATUS.put("XGSGeEstatus", TUBE1500WSTATUS.get(origin));
       STATUS.put("XGSGeDstatus", TUBE1500WSTATUS.get(origin));
       STATUS.put("XGSGeVal", TUBE1500WSTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", TUBE1500WSTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", TUBE1500WSTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", TUBE1500WSTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", TUBE1500WSTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", TUBE1500WSTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", TUBE1500WSTATUS.get(origin + "Fsub"));
    }
