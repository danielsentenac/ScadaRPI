...
public class GlgValveGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Valve Gui case
       STATUS.clear();
       STATUS.put("VCol", TUBE1500WSTATUS.get(origin + "Col"));
       STATUS.put("VStr", TUBE1500WSTATUS.get(origin));
	...
	public void InputCallback( GlgObject viewport, GlgObject message_obj )  {
	   ...
	   subaction = message_obj.GetSResource( "SubAction" );
           ...
           // Valve command
              ...
              logger.fine("origin=" + origin);
              logger.fine("cmdName=" + cmdName);
              logger.fine("COMMAND CHANNEL=" + cmdName.split("_",2)[1]);
