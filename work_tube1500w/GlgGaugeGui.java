...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", TUBE1500WSTATUS.get(origin));
       STATUS.put("Gestatus", TUBE1500WSTATUS.get(origin));
       STATUS.put("GePstatus", TUBE1500WSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", TUBE1500WSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", TUBE1500WSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", TUBE1500WSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", TUBE1500WSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", TUBE1500WSTATUS.get(origin));
       STATUS.put("GePStr", TUBE1500WSTATUS.get(origin + "Psub"));
