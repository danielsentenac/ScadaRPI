...
public class DialogStop extends JDialog implements Runnable {
    ...
    public DialogStop(JFrame _parent, String _title, boolean _modal) {
	try {
            parent = _parent;
            title = _title;
    ...
    public void run () {
     ...
     private void StopScan() {
        ...
        // Stop Scan
        SendCommandToSupervisor("ScanStop");
        // Lightoff filament
        SendCommandToSupervisor("FilamentControl Off");
        // Remove all scans
        SendCommandToSupervisor("MeasurementRemoveAll");
        // Release control
        SendCommandToSupervisor("Release");
