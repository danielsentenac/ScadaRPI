...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", TUBE1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", TUBE1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", TUBE1500WSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", TUBE1500WSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", TUBE1500WSTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", TUBE1500WSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", TUBE1500WSTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", TUBE1500WSTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", TUBE1500WSTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", TUBE1500WSTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", TUBE1500WSTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", TUBE1500WSTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", TUBE1500WSTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", TUBE1500WSTATUS.get(origin + "ScurrentValsub"));
    }
