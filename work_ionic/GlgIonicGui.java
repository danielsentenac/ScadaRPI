...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", TUBESTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", TUBESTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", TUBESTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", TUBESTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", TUBESTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", TUBESTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", TUBESTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", TUBESTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", TUBESTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", TUBESTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", TUBESTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", TUBESTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", TUBESTATUS.get(origin + "FcurrentValsub"));
