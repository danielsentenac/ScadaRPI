...
public class GlgValveGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Valve Gui case
       STATUS.clear();
       STATUS.put("Vname", TUBESTATUS.get(origin));
       STATUS.put("Vstatus", TUBESTATUS.get(origin));
       STATUS.put("VCol", TUBESTATUS.get(origin + "Col"));
       STATUS.put("VStr", TUBESTATUS.get(origin));
