...
public class SupervisorClient extends Device {
   ...
   public SupervisorClient (String _name,
     ...
     //        public void run() {
     for ( int i = 1; i < 9 ; i++ ) {
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM03", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM05", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM1", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM205", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM5", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM10", DataType.READ_ONLY_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_UM03FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=2));
       ...
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_SAMPLING", DataType.READ_AND_WRITE_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
       // Particle counter holding time value
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_HOLDING", DataType.READ_AND_WRITE_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
       // Particle counter cycle number value
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_CYCLE", DataType.READ_AND_WRITE_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
       // Particle counter flow value
       addDataElement( new DataElement(name, "VAC_PCOUNTERCB_PC" + i + "_FLOW", DataType.READ_ONLY_VALUE,RegisterType.INT16,mbRegisterEnd+=1));
   ...
   //    });
     ...
     for ( int i = 1; i < 9 ; i++ ) {
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM03");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM05");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM1");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM205");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM5");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_UM10");
       ...
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_SAMPLING");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_HOLDING");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_CYCLE");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_FLOW");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_INSTRST");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_ST");
       svrNameList.addElement("VAC_PCOUNTERCB_PC" + i + "_RackStatus");
     }
   ...
   public void updateDeviceData() {
     ...
     try {
        ...
        int pos = 0;
        for ( int i = 1; i < 9 ; i++ ) {
          DataElement d1v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM03");
	  DataElement d2v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM05");
	  DataElement d3v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM1");
	  DataElement d4v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM205");
	  DataElement d5v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM5");
	  DataElement d6v = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM10");
	  DataElement d1f = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM03FLG");
	  DataElement d2f = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM05FLG");
	  DataElement d3f=  getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM1FLG");
	  DataElement d4f = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM205FLG");
	  DataElement d5f = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM5FLG");
	  DataElement d6f = getDataElement("VAC_PCOUNTERCB_PC" + i + "_UM10FLG");
	  DataElement ds =  getDataElement("VAC_PCOUNTERCB_PC" + i + "_SAMPLING");
	  DataElement dh =  getDataElement("VAC_PCOUNTERCB_PC" + i + "_HOLDING");
	  DataElement dc =  getDataElement("VAC_PCOUNTERCB_PC" + i + "_CYCLE");
	  DataElement df =  getDataElement("VAC_PCOUNTERCB_PC" + i + "_FLOW");
	  DataElement dist = getDataElement("VAC_PCOUNTERCB_PC" + i + "_INSTRST");
	  DataElement dst = getDataElement("VAC_PCOUNTERCB_PC" + i + "_ST");
	  DataElement dcomst = getDataElement("VAC_PCOUNTERCB_PC" + i + "_COMST");
