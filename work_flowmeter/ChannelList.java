...
String mainDrawing = "FLOWMETER.g";

/***********************************************************************/
Hashtable<String, String> FLOWMETERCMD = new Hashtable<String, String>(){
...
//
put("START_RAMP","FM1_STARTRAMP_CMD");   // Type 2 (TRIGGER)
put("STOP_RAMP","FM1_STOPRAMP_CMD");   // Type 2 (TRIGGER)

//
// Valves
//
put("V22","SU_VAC_LAB1500N_2_V22CMD");          // Type 2 (TRIGGER)

}};
/***********************************************************************/
Hashtable<String, String> FLOWMETERSTATUS = new Hashtable<String, String>(){
...
// General Rack
//
put("FlowVal","FM1_FLOW");    // Visibility D Resource type
put("TempVal","FM1_TEMP");    // Visibility D Resource type
put("ValveposVal","FM1_VALVE_POS");   // Visibility D Resource type
put("FlowSetPVal","FM1_FLOW_SETP");     // Visibility D Resource type
put("RampVal","FM1_RAMP");            // Visibility D Resource type
put("ValveOpenVal","FM1_VALVE_OPEN");    // Visibility D Resource type
put("ValveCloseVal","FM1_VALVE_CLOSE");  // Visibility D Resource type
put("FlowZero","FM1_FLOW_ZERO");  // Visibility D Resource type

//
// Gauges
//
put("G1Val","SU_VAC_LAB1500N_1_PR1");        // Visibility D Resource type
put("G1Str","SU_VAC_LAB1500N_1_PR1SST");     // Visibility D Resource type
put("G1Col","SU_VAC_LAB1500N_1_PR1SST");     // G resource type
put("G1PStr","SU_VAC_LAB1500N_1_PR1ST");     // G resource type
put("G1PCol","SU_VAC_LAB1500N_1_PR1ST");     // G resource type

put("G2Val","SU_VAC_LAB1500N_2_PR7");     // Visibility D Resource type
put("G2Str","SU_VAC_LAB1500N_2_PR7SST");     // Visibility D Resource type
put("G2Col","SU_VAC_LAB1500N_2_PR7SST");  // G resource type
put("G2PStr","SU_VAC_LAB1500N_2_PR7ST");     // Visibility D Resource type
put("G2PCol","SU_VAC_LAB1500N_2_PR7ST");  // G resource type

//
// Valves
//
put("V22","SU_VAC_LAB1500N_2_V22ST");
put("V22Col","SU_VAC_LAB1500N_2_V22ST");
 

//
// RAMP PROGRAMMATION
//
put("FlowStepVal","FM1_FLOWSTEP");
put("FlowMaxVal","FM1_FLOWMAX");
put("TimeInterVal","FM1_TIMEINTER");
put("TimeVal","FM1_TIME");
