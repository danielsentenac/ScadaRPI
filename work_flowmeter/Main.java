...
public class Main {
    ...
    // Main Title GUI
    private static final String mainTitle = "FLOWMETER FM1";
    ...
    public static void main(String[] args) 
         ...
         try {
             ...
             FileHandler fileHandler = new FileHandler("FMCEB_" + LocalDate.now() + ".log");
        ...
        Device su = new SupervisorClient("SU", fm1.mbRegisterEnd); // Modbus start offset
        
        // Add su to DeviceManager
        deviceManager.addDevice(su);
        /**********************************************************************************************/
        ...
        /**********************************************************************************************/
        // Start (ModbusMaster) fm1 MKS flowmeter device
        fm1.doStart();
        // Start (SupervisorClient) su 
        su.doStart();
