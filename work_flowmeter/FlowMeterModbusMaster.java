...
public class FlowMeterModbusMaster extends Device {
   ...
   public FlowMeterModbusMaster (String _name,
     ...
     // For Operation
     addDataElement( new DataElement(name, "FLOWSTEP", DataType.READ_AND_WRITE_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=1));
     addDataElement( new DataElement(name, "FLOWMAX", DataType.READ_AND_WRITE_VALUE,RegisterType.FLOAT32,mbRegisterEnd+=2));
   ...
   public void executeCommand( DataElement e ) {
      ...
      try {
         if ( e.name.contains("FLOW_SETP") ) { // Flow Set point value
            ...
            System.out.println(" Set new value " + String.valueOf(value));
