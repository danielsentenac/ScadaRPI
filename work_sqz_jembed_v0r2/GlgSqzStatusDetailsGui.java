/*
 * This Class is used for SqzStatusDetails GUI using Glg Toolkit
 */
...
public class GlgSqzStatusDetailsGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgSqzStatusDetailsGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // SqzStatusDetails display
          glg_bean.SetDrawingFile("SqzStatusDetails.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // SqzStatusDetails Gui case
       STATUS.clear();
       STATUS.putAll(SqzStatusDetails);
    }
