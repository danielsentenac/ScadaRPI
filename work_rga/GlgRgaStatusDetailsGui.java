/*
 * This Class is used for RgaStatusDetails GUI using Glg Toolkit
 */
...
public class GlgRgaStatusDetailsGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgRgaStatusDetailsGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // RgaStatusDetails display
          glg_bean.SetDrawingFile("RgaStatusDetails.g");
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RgaStatusDetails Gui case
       STATUS.clear();
       STATUS.putAll(RgaStatusDetails);
    }
