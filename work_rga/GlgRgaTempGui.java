/*
 * This Class is used for RgaTemp GUI using Glg Toolkit
 */
...
public class GlgRgaTempGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgRgaTempGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // RgaTemp display
          glg_bean.SetDrawingFile("RgaTemp.g");
