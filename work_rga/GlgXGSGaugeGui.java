...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", RGASTATUS.get(origin));
       STATUS.put("XGSGeEstatus", RGASTATUS.get(origin));
       STATUS.put("XGSGeDstatus", RGASTATUS.get(origin));
       STATUS.put("XGSGeVal", RGASTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", RGASTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", RGASTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", RGASTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", RGASTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", RGASTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", RGASTATUS.get(origin + "Fsub"));
    }
