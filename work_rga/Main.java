...
public class Main {
    ...
    // Main Title GUI
    private static final String mainTitle = "RGA 1500N Station";
    ...
    public static void main(String[] args) 
         ...
         try {
             ...
             FileHandler fileHandler = new FileHandler("RGARack_" + LocalDate.now() + ".log");
        ...
        Device mg = new MaxiGauge("MG",
                                  ...
                                  "/dev/serial/by-id/usb-FTDI_USB-COM485_Plus4_FT3P01PW-if00-port0",
                                  Baud._9600, 
                                  DataBits._8,  
                                  Parity.NONE, 
                                  StopBits._1, 
        ...
        Device dcu = new TurboPfeifferDCU("DCU",
                                          ...
                                          "/dev/serial/by-id/usb-FTDI_USB-COM485_Plus4_FT3P01PW-if01-port0", 
                                          Baud._9600, 
                                          DataBits._8,  
                                          Parity.NONE, 
                                          StopBits._1, 
        ...
        Device controllino_3 = new Controllino_3("M3",
                                              0, // Modbus start offset first device created
                                              CONTROLLINO_3_ADDR);
        ...
        /**********************************************************************************************/
        // Create Rga HAL201RC (from Hiden) device
        Device hal201rc = new RgaHidenHal201RC("RGAGe4", 50,
                                              tcmuxshield.mbRegisterEnd, // Modbus start offset
                                              "/dev/serial/by-id/usb-FTDI_USB-COM232_Plus4_FT3N4F1T-if01-port0", 
                                              Baud._115200, 
                                              DataBits._8,  
                                              Parity.NONE, 
                                              StopBits._1, 
        ...
        /**********************************************************************************************/
        // Create Rga HAL201RC (from Hiden) device
        Device hal201rc2 = new RgaHidenHal201RC("RGAGc4", 300,
                                              hal201rc.mbRegisterEnd, // Modbus start offset
                                              "/dev/serial/by-id/usb-FTDI_USB-COM232_Plus4_FT3N4F1T-if00-port0",
                                              Baud._115200,
                                              DataBits._8,
                                              Parity.NONE,
                                              StopBits._1,
        ...
        tcmuxshield.doStart();
        // Start (RgaHidenHal201RC) rga device
        hal201rc.doStart();
        // Start (RgaHidenHal201RC) rga device
        hal201rc2.doStart();
