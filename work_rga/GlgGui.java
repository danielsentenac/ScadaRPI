...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : RGASTATUS.entrySet()) {
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("RgaStatusDetails") )
                          child = new GlgRgaStatusDetailsGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("RgaTemp") )
                          child = new GlgRgaTempGui(parent, deviceManager, title, origin);
