...
public class GlgTitaneGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Titane Gui case
       STATUS.clear();
       STATUS.put("Pname", RGASTATUS.get(origin));
       STATUS.put("P", RGASTATUS.get(origin));
       STATUS.put("PCol", RGASTATUS.get(origin));
       STATUS.put("PStr", RGASTATUS.get(origin));
       STATUS.put("PStart", RGASTATUS.get(origin + "Startsub"));
       STATUS.put("PStartCol", RGASTATUS.get(origin + "Startsub"));
       STATUS.put("PStartStr", RGASTATUS.get(origin + "Startsub"));
       STATUS.put("PCtrl", RGASTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlCol", RGASTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlStr", RGASTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PErr", RGASTATUS.get(origin + "Errsub"));
       STATUS.put("PErrCol", RGASTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", RGASTATUS.get(origin + "Errsub"));
       STATUS.put("PREmode", RGASTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeCol", RGASTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeStr", RGASTATUS.get(origin + "REmodesub"));
       STATUS.put("PFILmode", RGASTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeCol", RGASTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeStr", RGASTATUS.get(origin + "FILmodesub"));
       STATUS.put("POPmode", RGASTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeCol", RGASTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeStr", RGASTATUS.get(origin + "OPmodesub"));
       STATUS.put("PCTRLOPmode", RGASTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeCol", RGASTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeStr", RGASTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PAcurrentVal", RGASTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PAvoltageVal", RGASTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PSublcurrentVal", RGASTATUS.get(origin + "SublcurrentValsub"));
       STATUS.put("PSubltimeVal", RGASTATUS.get(origin + "SubltimeValsub"));
       STATUS.put("PSublperiodVal", RGASTATUS.get(origin + "SublperiodValsub"));
       STATUS.put("PSublwaitVal", RGASTATUS.get(origin + "SublwaitValsub"));
       STATUS.put("PCycleVal", RGASTATUS.get(origin + "CycleValsub"));
       STATUS.put("PHrVal", RGASTATUS.get(origin + "HrValsub"));
       STATUS.put("PBTempVal", RGASTATUS.get(origin + "BTempValsub"));
    }
