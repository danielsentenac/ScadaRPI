...
public class GlgRGA3Gui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAoperation", RGASTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationCol", RGASTATUS.get(origin + "operationsub"));
       STATUS.put("RGAoperationStr", RGASTATUS.get(origin + "operationsub"));
       ...
       STATUS.put("FilamentStatus", RGASTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusCol", RGASTATUS.get(origin + "filamentsub"));
       STATUS.put("FilamentStatusStr", RGASTATUS.get(origin + "filamentsub"));
       STATUS.put("ElectronEnergy", RGASTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyCol", RGASTATUS.get(origin + "electronenergysub"));
       STATUS.put("ElectronEnergyStr", RGASTATUS.get(origin + "electronenergysub"));
       STATUS.put("Emission", RGASTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionCol", RGASTATUS.get(origin + "emissionsub"));
       STATUS.put("EmissionStr", RGASTATUS.get(origin + "emissionsub"));
       STATUS.put("Multiplier", RGASTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierCol", RGASTATUS.get(origin + "multipliersub"));
       STATUS.put("MultiplierStr", RGASTATUS.get(origin + "multipliersub"));
       STATUS.put("Focus", RGASTATUS.get(origin + "focussub"));
       STATUS.put("FocusCol", RGASTATUS.get(origin + "focussub"));
       STATUS.put("FocusStr", RGASTATUS.get(origin + "focussub"));
       STATUS.put("Cage", RGASTATUS.get(origin + "cagesub"));
       STATUS.put("CageCol", RGASTATUS.get(origin + "cagesub"));
       STATUS.put("CageStr", RGASTATUS.get(origin + "cagesub"));
