...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", RGASTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", RGASTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", RGASTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", RGASTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", RGASTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", RGASTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", RGASTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", RGASTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", RGASTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", RGASTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", RGASTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", RGASTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", RGASTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", RGASTATUS.get(origin + "ScurrentValsub"));
    }
