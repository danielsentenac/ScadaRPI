...
public class DialogOp extends JDialog {
    ...
    void jButtonOK_actionPerformed(ActionEvent e) {
        System.out.println("Set new parameter for " + origin + "=" + jTextField.getText());
        logger.finer("Set new parameter for CAZZO " + origin + "=" + jTextField.getText());
        if (!jTextField.getText().equals("")) {
           logger.finer("Set new parameter for " + origin + "=" + jTextField.getText());
           int value = Integer.valueOf(jTextField.getText());
	   // Update parameter
           try {
            if ( origin.contains("AcqTime") ) {
                System.out.println("Set new parameter for 2 " + origin + "=" + value);
                op.setAcqTime(value);
                }
