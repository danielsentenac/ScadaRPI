/*
 * This Class is used for TubeStatusDetails GUI using Glg Toolkit
 */
...
public class GlgTubeStatusDetailsGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgTubeStatusDetailsGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    public void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // TubeStatusDetails Gui case
       STATUS.clear();
       STATUS.putAll(TubeStatusDetails);
    }
