...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", TUBESTATUS.get(origin));
       STATUS.put("Gestatus", TUBESTATUS.get(origin));
       STATUS.put("GePstatus", TUBESTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", TUBESTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", TUBESTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", TUBESTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", TUBESTATUS.get(origin + "Col"));
       STATUS.put("GeStr", TUBESTATUS.get(origin));
       STATUS.put("GePStr", TUBESTATUS.get(origin + "Psub"));
    }
