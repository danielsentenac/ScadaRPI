...
public class GlgTurboPfeifferDCUGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PErr", TUBESTATUS.get(origin));
       STATUS.put("PErrCol", TUBESTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", TUBESTATUS.get(origin + "Errsub"));
       STATUS.put("PErrVal", TUBESTATUS.get(origin + "ErrValsub"));
       STATUS.put("PSty", TUBESTATUS.get(origin));
       STATUS.put("PStyCol", TUBESTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", TUBESTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", TUBESTATUS.get(origin));
       STATUS.put("PTempCol", TUBESTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", TUBESTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempVal", TUBESTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTemp", TUBESTATUS.get(origin));
       STATUS.put("PBTempCol", TUBESTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", TUBESTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempVal", TUBESTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", TUBESTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", TUBESTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", TUBESTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", TUBESTATUS.get(origin + "HoursValsub"));      
    }
