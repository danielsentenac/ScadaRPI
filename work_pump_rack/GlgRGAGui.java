...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", TUBESTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", TUBESTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", TUBESTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAdegas", TUBESTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", TUBESTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", TUBESTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", TUBESTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", TUBESTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", TUBESTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", TUBESTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", TUBESTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", TUBESTATUS.get(origin + "modesub"));
       STATUS.put("RGAfilament", TUBESTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", TUBESTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", TUBESTATUS.get(origin + "filamentsub"));
       String channelName =  STATUS.get("RGAemission");
       // Get corresponding device from deviceManager
       String deviceName = channelName.split("_")[0];
