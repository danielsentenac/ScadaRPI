...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", TUBESTATUS.get(origin));
       STATUS.put("XGSGeEstatus", TUBESTATUS.get(origin));
       STATUS.put("XGSGeDstatus", TUBESTATUS.get(origin));
       STATUS.put("XGSGeVal", TUBESTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", TUBESTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", TUBESTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", TUBESTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", TUBESTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", TUBESTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", TUBESTATUS.get(origin + "Fsub"));
    }
