...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : TUBESTATUS.entrySet()) {
         ...
         if ( device != null ) {
            ...
            //if (dataElement == null) {
            //logger.finer("GlgGui:updateGui> dataName= " + dataName + " glgName=" + glgName + " device name=" + deviceName);
              // continue;
            //}
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("TubeStatusDetails") )
                          child = new GlgTubeStatusDetailsGui(parent, deviceManager, title, origin);
