...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", HIDENBENCHSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", HIDENBENCHSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", HIDENBENCHSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAdegas", HIDENBENCHSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", HIDENBENCHSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", HIDENBENCHSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", HIDENBENCHSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", HIDENBENCHSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", HIDENBENCHSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", HIDENBENCHSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", HIDENBENCHSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", HIDENBENCHSTATUS.get(origin + "modesub"));
       STATUS.put("RGAfilament", HIDENBENCHSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", HIDENBENCHSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", HIDENBENCHSTATUS.get(origin + "filamentsub"));
       ...
       for ( int j = 0 ; j < 200 ; j++) {// RGA data (plot)
          int index = j + 1;
          glg_bean.SetSResource("/RGA/DataGroup/DataSample" + j + "/TooltipLabel", 
                                "Mass:" + Integer.toString(j+1) ); // Set tooltip label
          if (index < 10 ) 
             STATUS.put("/RGA/DataGroup/DataSample" + j + "/Value", deviceName + "_" + origin.toUpperCase() + ".00" + index);
          else if ( index >= 10 && index < 100 ) 
             STATUS.put("/RGA/DataGroup/DataSample" + j + "/Value", deviceName + "_" + origin.toUpperCase() + ".0" + index);
          else
             STATUS.put("/RGA/DataGroup/DataSample" + j + "/Value", deviceName + "_" + origin.toUpperCase() + "." + index);
       }
    }
