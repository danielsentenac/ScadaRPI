...
String mainDrawing = "HIDENBENCH.g";

/***********************************************************************/
Hashtable<String, String> HIDENBENCHCMD = new Hashtable<String, String>(){
...
// Gauges
//
put("G22_A","MG_PR1ONOFF");         // Type 2 (TRIGGER)
put("G22_B","MG_PR2ONOFF");          // Type 2 (TRIGGER)
//
// Valves
//
put("V21_A","M1_V21ACMD");          // Type 2 (TRIGGER)
put("V21_B","M1_V21BCMD");           // Type 2 (TRIGGER)
put("V22_A","M1_V22ACMD");          // Type 2 (TRIGGER)
put("V22_B","M1_V22BCMD");           // Type 2 (TRIGGER)

//
// Dry Pumps
//
put("DryP22_A","M1_P22AONOFF");     // Type 2 (TRIGGER)
put("DryP22_B","M1_P22BONOFF");      // Type 2 (TRIGGER)
put("Bypass","M1_BYPASSONOFF");   // Type 2 (TRIGGER)

//
// Turbo Pumps
//
put("TurboP21_A","TurboA_P21ONOFF");             // Type 2 (TRIGGER)
put("TurboP21_ASty","TurboA_P21STYONOFF");       // Type 2 (TRIGGER)
put("TurboP21_B","TurboB_P21ONOFF");             // Type 2 (TRIGGER)
put("TurboP21_BSty","TurboB_P21STYONOFF");       // Type 2 (TRIGGER)

}};
/***********************************************************************/
Hashtable<String, String> HIDENBENCHSTATUS = new Hashtable<String, String>(){
...
//
put("V21_A","M1_V21AST");
put("V21_ACol","M1_V21AST");
put("V21_B","M1_V21BST");
put("V21_BCol","M1_V21BST");

put("V22_A","M1_V22AST");
put("V22_ACol","M1_V22AST");
put("V22_B","M1_V22BST");
put("V22_BCol","M1_V22BST");

//
// Gauges (Maxigauge device)
//
put("G22_A","MG_PR1SST");     // D resource type (visibility)
put("G22_APsub","MG_PR1ST");     // D resource type (visibility)
put("G22_AVal","MG_PR1");    // D resource type
put("G22_ACol","MG_PR1SST");  // G resource type
put("G22_APColsub","MG_PR1ST");  // G resource type
put("G22_B","MG_PR2SST");     // D resource type (visibility)
put("G22_BPsub","MG_PR2ST");     // D resource type (visibility)
put("G22_BVal","MG_PR2");    // D resource type
put("G22_BCol","MG_PR2SST");  // G resource type
put("G22_BPColsub","MG_PR2ST");  // G resource type

//
// Dry Pump
//
put("DryP22_A","M1_P22AST");
put("DryP22_ACol","M1_P22AST");
put("DryP22_B","M1_P22BST");
put("DryP22_BCol","M1_P22BST");
//
// Turbo Pumps
//
put("TurboP21_A","TurboA_P21ST");
put("TurboP21_ACol","TurboA_P21ST");
put("TurboP21_ASpeedVal","TurboA_P21SPEED");
put("TurboP21_APowerVal","TurboA_P21PWR");
put("TurboP21_AStysub","TurboA_P21STYST");
put("TurboP21_ATempsub","NULL");
put("TurboP21_ABTempsub","NULL");
put("TurboP21_AErrsub","TurboA_P21BERR");
put("TurboP21_ATempValsub","TurboA_P21TEMP");
put("TurboP21_ABTempValsub","TurboA_P21BTEMP");
put("TurboP21_ASpeedValsub","TurboA_P21SPEED");
put("TurboP21_APowerValsub","TurboA_P21PWR");
put("TurboP21_AFspeedValsub","TurboA_P21FSPEED");
put("TurboP21_AHoursValsub","TurboA_P21HR");

put("TurboP21_B","TurboB_P21ST");
put("TurboP21_BCol","TurboB_P21ST");
put("TurboP21_BSpeedVal","TurboB_P21SPEED");
put("TurboP21_BPowerVal","TurboB_P21PWR");
put("TurboP21_BStysub","TurboB_P21STYST");
put("TurboP21_BTempsub","TurboB_P21TPST");
put("TurboP21_BBTempsub","TurboB_P21BTPST");
put("TurboP21_BErrsub","TurboB_P21BERR");
put("TurboP21_BTempValsub","NULL");
put("TurboP21_BBTempValsub","NULL");
put("TurboP21_BSpeedValsub","TurboB_P21SPEED");
put("TurboP21_BPowerValsub","TurboB_P21PWR");
put("TurboP21_BFspeedValsub","TurboB_P21FSPEED");
put("TurboP21_BHoursValsub","TurboB_P21HR");

// Bypass
put("BypassVal","M1_BYPASSST"); 
...
//
/***********************************************************************/
Hashtable<String, String> HidenBenchStatusDetails = new Hashtable<String, String>(){
...
put("AlarmComTurboP21_A","TurboA_P21COMST");
put("AlarmComTurboP21_AStr","TurboA_P21COMST");
put("AlarmComTurboP21_ACol","TurboA_P21COMST");
put("AlarmComTurboP21_B","TurboB_P21COMST");
put("AlarmComTurboP21_BStr","TurboB_P21COMST");
put("AlarmComTurboP21_BCol","TurboB_P21COMST");
put("AlarmComM1","M1_COMST");
put("AlarmComM1Str","M1_COMST");
put("AlarmComM1Col","M1_COMST");
put("AirCompressed","M1_AIRPRESSUREST");
put("AirCompressedStr","M1_AIRPRESSUREST");
put("AirCompressedCol","M1_AIRPRESSUREST");
put("Bypass","M1_BYPASSST");
put("BypassStr","M1_BYPASSST");
put("BypassCol","M1_BYPASSST");
