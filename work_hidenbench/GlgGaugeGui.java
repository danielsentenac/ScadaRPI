...
public class GlgGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("Gename", HIDENBENCHSTATUS.get(origin));
       STATUS.put("Gestatus", HIDENBENCHSTATUS.get(origin));
       STATUS.put("GePstatus", HIDENBENCHSTATUS.get(origin + "Psub"));
       STATUS.put("GeVal", HIDENBENCHSTATUS.get(origin + "Val"));
       STATUS.put("GeCol1", HIDENBENCHSTATUS.get(origin + "Col"));
       STATUS.put("GePCol1", HIDENBENCHSTATUS.get(origin + "PColsub"));
       STATUS.put("GeCol2", HIDENBENCHSTATUS.get(origin + "Col"));
       STATUS.put("GeStr", HIDENBENCHSTATUS.get(origin));
       STATUS.put("GePStr", HIDENBENCHSTATUS.get(origin + "Psub"));
    }
