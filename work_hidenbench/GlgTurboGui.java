...
public class GlgTurboGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Turbo Gui case
       STATUS.clear();
       STATUS.put("Pname", HIDENBENCHSTATUS.get(origin));
       STATUS.put("P", HIDENBENCHSTATUS.get(origin));
       STATUS.put("PCol", HIDENBENCHSTATUS.get(origin));
       STATUS.put("PStr", HIDENBENCHSTATUS.get(origin));
       STATUS.put("PErr", HIDENBENCHSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrCol", HIDENBENCHSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", HIDENBENCHSTATUS.get(origin + "Errsub"));
       STATUS.put("PSty", HIDENBENCHSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyCol", HIDENBENCHSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", HIDENBENCHSTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", HIDENBENCHSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempCol", HIDENBENCHSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", HIDENBENCHSTATUS.get(origin + "Tempsub"));
       STATUS.put("PBTemp", HIDENBENCHSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempCol", HIDENBENCHSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", HIDENBENCHSTATUS.get(origin + "BTempsub"));
       STATUS.put("PTempVal", HIDENBENCHSTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTempVal", HIDENBENCHSTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", HIDENBENCHSTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", HIDENBENCHSTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", HIDENBENCHSTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", HIDENBENCHSTATUS.get(origin + "HoursValsub"));      
    }
