...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : HIDENBENCHSTATUS.entrySet()) {
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("HidenBenchStatusDetails") )
                          child = new GlgHidenBenchStatusDetailsGui(parent, deviceManager, title, origin);
                       ...
                       else if ( origin.equals("TurboP21_A") || origin.equals("TurboP21_B")  )
