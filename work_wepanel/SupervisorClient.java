...
public class SupervisorClient extends Device {
 ...
 //    SwingUtilities.invokeLater(new Runnable() {
  //        public void run() {
     for (int i = 1; i <= 8; i++) {
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM03FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM05FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM1FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM205FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM5FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_UM10FLG", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_INSTRST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_ST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
       addDataElement( new DataElement(name, "VAC_PCOUNTERWE_PC" + i + "_COMST", DataType.READ_ONLY_STATUS,RegisterType.INT16,mbRegisterEnd+=1));
     }
   ...
   //    });
     ...
     for (int i = 1; i <= 8; i++) {
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM03FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM05FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM1FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM205FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM5FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_UM10FLG");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_INSTRST");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_ST");
       svrNameList.addElement("VAC_PCOUNTERWE_PC" + i + "_COMST");
     }
     for (int i = 1; i <= 3; i++) {
   ...
   public void updateDeviceData() {
     ...
     try {
        ...
        int pos = 0;
        for (int i = 1; i <= 8; i++) {
       		DataElement d1 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM03FLG");
       		DataElement d2 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM05FLG");
      		DataElement d3 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM1FLG");
       		DataElement d4 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM205FLG");
       		DataElement d5 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM5FLG");
       		DataElement d6 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_UM10FLG");
       		DataElement d7 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_INSTRST");
       		DataElement d8 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_ST");
       		DataElement d9 = getDataElement("VAC_PCOUNTERWE_PC" + i + "_COMST");
