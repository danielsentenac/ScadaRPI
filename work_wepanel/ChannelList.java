...
// PC3
//
put("WETowerCleanStatus03","SC_VAC_PCOUNTERWE_PC3_UM03FLG");
put("WETowerCleanStatus05","SC_VAC_PCOUNTERWE_PC3_UM05FLG");
put("WETowerCleanStatus1","SC_VAC_PCOUNTERWE_PC3_UM1FLG");
put("WETowerCleanStatus205","SC_VAC_PCOUNTERWE_PC3_UM205FLG");
put("WETowerCleanStatus5","SC_VAC_PCOUNTERWE_PC3_UM5FLG");
put("WETowerCleanStatus10","SC_VAC_PCOUNTERWE_PC3_UM10FLG");
put("WETowerCleanError","SC_VAC_PCOUNTERWE_PC3_INSTRST");
put("WETowerCleanRunning","SC_VAC_PCOUNTERWE_PC3_ST");
put("WETowerCleanCom","SC_VAC_PCOUNTERWE_PC3_COMST");

//
// PC4
//
put("WEHallStatus03","SC_VAC_PCOUNTERWE_PC4_UM03FLG");
put("WEHallStatus05","SC_VAC_PCOUNTERWE_PC4_UM05FLG");
put("WEHallStatus1","SC_VAC_PCOUNTERWE_PC4_UM1FLG");
put("WEHallStatus205","SC_VAC_PCOUNTERWE_PC4_UM205FLG");
put("WEHallStatus5","SC_VAC_PCOUNTERWE_PC4_UM5FLG");
put("WEHallStatus10","SC_VAC_PCOUNTERWE_PC4_UM10FLG");
put("WEHallError","SC_VAC_PCOUNTERWE_PC4_INSTRST");
put("WEHallRunning","SC_VAC_PCOUNTERWE_PC4_ST");
put("WEHallCom","SC_VAC_PCOUNTERWE_PC4_COMST");
