...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    public void updateGui() {
       ...
       */
       ...
       if ( dev != null ) {
          ...
          if ( dcom.value == 1 ) {
              glg_bean2.SetGTag( "WEGeneralCol", new GlgPoint(0.5,0.5,0.5), true ); // General color Alarm
      	      glg_bean2.SetGTag( "WEZoneFrameCol", new GlgPoint(0.5,0.5,0.5), true ); // General Frame color Alarm
              glg_bean2.SetGTag( "WETunnelZoneCol", new GlgPoint(0.5,0.5,0.5), true ); // Wi color Alarm
              glg_bean2.SetGTag( "WETunnelZoneFrameCol", new GlgPoint(0.5,0.5,0.5), true ); // Wi Frame color Alarm
              glg_bean2.SetGTag( "WEBaseZoneCol", new GlgPoint(0.5,0.5,0.5), true ); // Inj color Alarm
              glg_bean2.SetGTag( "WEBaseZoneFrameCol", new GlgPoint(0.5,0.5,0.5), true ); // Inj Frame color Alarm
              glg_bean2.SetGTag( "WECryoZoneCol", new GlgPoint(0.5,0.5,0.5), true ); // Det color Alarm
              glg_bean2.SetGTag( "WECryoZoneFrameCol", new GlgPoint(0.5,0.5,0.5), true ); // Det Frame color Alarm
              glg_bean2.SetGTag( "WECleanZoneCol", new GlgPoint(0.5,0.5,0.5), true ); // Clean color Alarm
              glg_bean2.SetGTag( "WECleanZoneFrameCol", new GlgPoint(0.5,0.5,0.5), true ); // Clean Frame color Alarm
       ...
       for (Map.Entry<String, String> e : PANEL2STATUS.entrySet()) {
         ...
         if ( device != null ) {
		   ...
		   if ( status[2] == 1 || status[3] == 1 || status[4] == 1 || status[11] == 1 || status[15] == 1 ) { // Alarm (1,2,3 levels), Alarm to be resetted - Report
		       ...
		       if ( status[2] == 1 || status[3] == 1 || status[4] == 1) {
			   WEGeneralOKst = false;
			   WEGeneralStr = "WE BUILDING: CALL/CONTATTARE VACUUM ONCALL/CONTROL ROOM";
                       }
		       if (glgName.contains("TOWER")) { // Cryotrap Zone
			   WECryoOKst = false;
    ...
    */
    if (WEGeneralOKst == false) {
      ...
      glg_bean2.SetSTag( "WEGeneralStr", "WE BUILDING O2 SENSOR MONITORING : OK" , true ); // WE General OK
