...
public class GlgTurboGui extends GlgChildGui {
    ...
    protected void createAndShowGui () {
	  ...
	  content.add( glg_bean ); 
          ...
          // CAOS: show the clean base name (drop the "_1"/"_2" chamber suffix);
          // lookups below still use the full suffixed origin.
          String baseName = origin.matches(".*_[12]$") ? origin.substring(0, origin.length() - 2) : origin;
          glg_bean.SetSTag("Pname", baseName, true);
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PSty", CAOSSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyCol", CAOSSTATUS.get(origin + "Stysub"));
       STATUS.put("PStyStr", CAOSSTATUS.get(origin + "Stysub"));
       STATUS.put("PTemp", CAOSSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempCol", CAOSSTATUS.get(origin + "Tempsub"));
       STATUS.put("PTempStr", CAOSSTATUS.get(origin + "Tempsub"));
       STATUS.put("PBTemp", CAOSSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempCol", CAOSSTATUS.get(origin + "BTempsub"));
       STATUS.put("PBTempStr", CAOSSTATUS.get(origin + "BTempsub"));
       STATUS.put("PTempVal", CAOSSTATUS.get(origin + "TempValsub"));
       STATUS.put("PBTempVal", CAOSSTATUS.get(origin + "BTempValsub"));
       STATUS.put("PSpeedVal", CAOSSTATUS.get(origin + "SpeedValsub"));
       STATUS.put("PPowerVal", CAOSSTATUS.get(origin + "PowerValsub"));
       STATUS.put("PFspeedVal", CAOSSTATUS.get(origin + "FspeedValsub"));
       STATUS.put("PHoursVal", CAOSSTATUS.get(origin + "HoursValsub"));      
    }
