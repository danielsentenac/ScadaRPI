/*
 * This Class is used for CaosTemp GUI using Glg Toolkit
 */
...
public class GlgCaosTempGui extends GlgChildGui {

    private static final long serialVersionUID = 354054054072L;
    private static final Logger logger = Logger.getLogger("Main");

    public GlgCaosTempGui (GlgGui _parent, DeviceManager _deviceManager, String _title, String _origin) {
    ...
    protected void createAndShowGui () {
       ...
       try {
          ...
          // CaosTemp display
          glg_bean.SetDrawingFile("CaosTemp.g");
