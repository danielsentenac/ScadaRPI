...
public class GlgIonicGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       STATUS.put("PVmode", CAOSSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeCol", CAOSSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PVmodeStr", CAOSSTATUS.get(origin + "Vmodesub"));
       STATUS.put("PAcurrentVal", CAOSSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PcurrentVal", CAOSSTATUS.get(origin + "PcurrentValsub"));
       STATUS.put("PAvoltageVal", CAOSSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PressureVal", CAOSSTATUS.get(origin + "PressureValsub"));
       STATUS.put("PMcurrentVal", CAOSSTATUS.get(origin + "McurrentValsub"));
       STATUS.put("PMvoltageVal", CAOSSTATUS.get(origin + "MvoltageValsub")); 
       STATUS.put("PMpowerVal", CAOSSTATUS.get(origin + "MpowerValsub"));
       STATUS.put("PFvoltageVal", CAOSSTATUS.get(origin + "FvoltageValsub"));
       STATUS.put("PSvoltageVal", CAOSSTATUS.get(origin + "SvoltageValsub"));
       STATUS.put("PFcurrentVal", CAOSSTATUS.get(origin + "FcurrentValsub"));
       STATUS.put("PScurrentVal", CAOSSTATUS.get(origin + "ScurrentValsub"));
    }
