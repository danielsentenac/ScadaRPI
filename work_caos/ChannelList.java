...
String mainDrawing = "CAOS.g";

/***********************************************************************/
//
// CAOS: two identical per-chamber sets of devices.
// Suffix _1 = chamber 1 (BEAM SPLITTER):  MG1, DCU1, M1 (pump), M2 (vent)
// Suffix _2 = chamber 2 (EST END):        MG2, DCU2, M3 (pump), M4 (vent)
// VREM (tube remote vent valve) is driven by the VSPARE slot of M4.
// Singles: TCMUX, RGAGe4.
//
/***********************************************************************/
Hashtable<String, String> CAOSCMD = new Hashtable<String, String>(){
...
// Gauges
//
put("G22_1","MG1_PR1ONOFF");                // Type 2 (TRIGGER)
put("G21_1","MG1_PR2ONOFF");                // Type 2 (TRIGGER)
put("Ge1_1","MG1_PR3ONOFF");                // Type 2 (TRIGGER)
put("Ge3_1","MG1_PR4ONOFF");                // Type 2 (TRIGGER)
put("Ge2_1","MG1_PR5ONOFF");                // Type 2 (TRIGGER)
put("Gp","MG1_PR6ONOFF");                   // Type 2 (TRIGGER) - single Gp on MG1
put("G22_2","MG2_PR1ONOFF");                // Type 2 (TRIGGER)
put("G21_2","MG2_PR2ONOFF");                // Type 2 (TRIGGER)
put("Ge1_2","MG2_PR3ONOFF");                // Type 2 (TRIGGER)
put("Ge3_2","MG2_PR4ONOFF");                // Type 2 (TRIGGER)
put("Ge2_2","MG2_PR5ONOFF");                // Type 2 (TRIGGER)
//
// Valves
//
put("V21_1","M1_V21CMD");         // Type 2 (TRIGGER)
put("V22_1","M1_V22CMD");         // Type 2 (TRIGGER)
put("V1_1","M1_V1CMD");           // Type 2 (TRIGGER)
put("V24_1","M2_V24CMD");         // Type 2 (TRIGGER)
put("V25_1","M2_V25CMD");         // Type 2 (TRIGGER)
put("Vp","M2_VPCMD");             // Type 2 (TRIGGER) - single Vp on M2 (chamber 1 vent)
put("V21_2","M3_V21CMD");         // Type 2 (TRIGGER)
put("V22_2","M3_V22CMD");         // Type 2 (TRIGGER)
put("V1_2","M3_V1CMD");           // Type 2 (TRIGGER)
put("V24_2","M4_V24CMD");         // Type 2 (TRIGGER)
put("V25_2","M4_V25CMD");         // Type 2 (TRIGGER)
put("Vrem","M2_VSPAREONOFF");     // Type 2 (TRIGGER) - Vrem on M2 VSPARE slot
//
// Dry Pumps
//
put("DryP22_1","M1_P22ONOFF");    // Type 2 (TRIGGER)
put("DryP22_2","M3_P22ONOFF");    // Type 2 (TRIGGER)

//
// Turbo Pumps
//
put("TurboP21_1","DCU1_P21ONOFF");          // Type 2 (TRIGGER)
put("TurboP21_1Sty","DCU1_P21STYONOFF");    // Type 2 (TRIGGER)
put("TurboP21_2","DCU2_P21ONOFF");          // Type 2 (TRIGGER)
put("TurboP21_2Sty","DCU2_P21STYONOFF");    // Type 2 (TRIGGER)

//
// Bypass
//
put("BypassG22_1","M1_BYPASSONOFF");// Type 2 (TRIGGER)
put("BypassG22_2","M3_BYPASSONOFF");// Type 2 (TRIGGER)
put("BypassGp","M2_BYPASSONOFF");   // Type 2 (TRIGGER) - single Gp bypass on M2 (chamber 1 vent)

//
// RGA (QMS)
//
// Chamber 1 RGA (RGAGe4)
put("Ge4_1running","RGAGe4_RUNNINGONOFF");   // Type 2 (TRIGGER)
put("Ge4_1emission","RGAGe4_EMISSIONONOFF"); // Type 2 (TRIGGER)
put("Ge4_1degas","RGAGe4_DEGASONOFF");       // Type 2 (TRIGGER)
put("Ge4_1SEM","RGAGe4_SEMONOFF");           // Type 2 (TRIGGER)
// Chamber 2 RGA (RGAGe42)
put("Ge4_2running","RGAGe42_RUNNINGONOFF");   // Type 2 (TRIGGER)
put("Ge4_2emission","RGAGe42_EMISSIONONOFF"); // Type 2 (TRIGGER)
put("Ge4_2degas","RGAGe42_DEGASONOFF");       // Type 2 (TRIGGER)
put("Ge4_2SEM","RGAGe42_SEMONOFF");           // Type 2 (TRIGGER)


}};
/***********************************************************************/
Hashtable<String, String> CAOSSTATUS = new Hashtable<String, String>(){
...
//
// Valves (Controllino devices)
// Chamber 1 (BEAM SPLITTER): M1 pump / M2 vent
//
put("V21_1","M1_V21ST");    // Visibility D Resource type
put("V21_1Col","M1_V21ST"); // Color G Resource type
put("V22_1","M1_V22ST");
put("V22_1Col","M1_V22ST");
put("V1_1","M1_V1ST");
put("V1_1Col","M1_V1ST");
put("V23_1","M1_V23ST");
put("V23_1Col","M1_V23ST");
put("V24_1","M2_V24ST");
put("V24_1Col","M2_V24ST");
put("V25_1","M2_V24ST");
put("V25_1Col","M2_V24ST");
put("Vp","M2_VPST");            // single Vp on M2 (chamber 1 vent)
put("VpCol","M2_VPST");
put("Ve1_1","M2_VE1ST");
put("Ve1_1Col","M2_VE1ST");
put("Ve2_1","M2_VE2ST");
put("Ve2_1Col","M2_VE2ST");
//
// Chamber 2 (EST END): M3 pump / M4 vent
//
put("V21_2","M3_V21ST");
put("V21_2Col","M3_V21ST");
put("V22_2","M3_V22ST");
put("V22_2Col","M3_V22ST");
put("V1_2","M3_V1ST");
put("V1_2Col","M3_V1ST");
put("V23_2","M3_V23ST");
put("V23_2Col","M3_V23ST");
put("V24_2","M4_V24ST");
put("V24_2Col","M4_V24ST");
put("V25_2","M4_V24ST");
put("V25_2Col","M4_V24ST");
put("Ve1_2","M4_VE1ST");
put("Ve1_2Col","M4_VE1ST");
put("Ve2_2","M4_VE2ST");
put("Ve2_2Col","M4_VE2ST");
//
// Vrem (tube remote vent valve) on M2 VSPARE slot
//
put("Vrem","M2_VSPAREST");
put("VremCol","M2_VSPAREST");

//
// Gauges (Maxigauge devices)
// Chamber 1 (BEAM SPLITTER): MG1
//
put("G22_1","MG1_PR1SST");     // D resource type (visibility)
put("G22_1Psub","MG1_PR1ST");     // D resource type (visibility)
put("G22_1Val","MG1_PR1");    // D resource type
put("G22_1Col","MG1_PR1SST");  // G resource type
put("G22_1PColsub","MG1_PR1ST");  // G resource type
put("G21_1","MG1_PR2SST");     // D resource type (visibility)
put("G21_1Psub","MG1_PR2ST");     // D resource type (visibility)
put("G21_1Val","MG1_PR2");    // D resource type
put("G21_1Col","MG1_PR2SST");  // G resource type
put("G21_1PColsub","MG1_PR2ST");  // G resource type
put("Ge1_1","MG1_PR3SST");     // D resource type (visibility)
put("Ge1_1Psub","MG1_PR3ST");     // D resource type (visibility)
put("Ge1_1Val","MG1_PR3");    // D resource type
put("Ge1_1Col","MG1_PR3SST");  // G resource type
put("Ge1_1PColsub","MG1_PR3ST");  // G resource type
put("Ge2_1","MG1_PR4SST");     // D resource type (visibility)
put("Ge2_1Psub","MG1_PR4ST");     // D resource type (visibility)
put("Ge2_1Val","MG1_PR4");    // D resource type
put("Ge2_1Col","MG1_PR4SST");  // G resource type
put("Ge2_1PColsub","MG1_PR4ST");  // G resource type
put("Ge3_1","MG1_PR5SST");     // D resource type (visibility)
put("Ge3_1Psub","MG1_PR5ST");     // D resource type (visibility)
put("Ge3_1Val","MG1_PR5");    // D resource type
put("Ge3_1Col","MG1_PR5SST");  // G resource type
put("Ge3_1PColsub","MG1_PR5ST");  // G resource type
put("Gp","MG1_PR6SST");       // single Gp on MaxiGauge_1 (MG1) — D resource type (visibility)
put("GpPsub","MG1_PR6ST");       // D resource type (visibility)
put("GpVal","MG1_PR6");      // D resource type
put("GpCol","MG1_PR6SST");    // G resource type
put("GpPColsub","MG1_PR6ST");    // G resource type
//
// Chamber 2 (EST END): MG2
//
put("G22_2","MG2_PR1SST");
put("G22_2Psub","MG2_PR1ST");
put("G22_2Val","MG2_PR1");
put("G22_2Col","MG2_PR1SST");
put("G22_2PColsub","MG2_PR1ST");
put("G21_2","MG2_PR2SST");
put("G21_2Psub","MG2_PR2ST");
put("G21_2Val","MG2_PR2");
put("G21_2Col","MG2_PR2SST");
put("G21_2PColsub","MG2_PR2ST");
put("Ge1_2","MG2_PR3SST");
put("Ge1_2Psub","MG2_PR3ST");
put("Ge1_2Val","MG2_PR3");
put("Ge1_2Col","MG2_PR3SST");
put("Ge1_2PColsub","MG2_PR3ST");
put("Ge2_2","MG2_PR4SST");
put("Ge2_2Psub","MG2_PR4ST");
put("Ge2_2Val","MG2_PR4");
put("Ge2_2Col","MG2_PR4SST");
put("Ge2_2PColsub","MG2_PR4ST");
put("Ge3_2","MG2_PR5SST");
put("Ge3_2Psub","MG2_PR5ST");
put("Ge3_2Val","MG2_PR5");
put("Ge3_2Col","MG2_PR5SST");
put("Ge3_2PColsub","MG2_PR5ST");
//
// RGA (single)
//
// Chamber 1 RGA (RGAGe4)
put("Ge4_1","RGAGe4_RUNNING");     // D resource type (visibility)
put("Ge4_1Col","RGAGe4_RUNNING");  // G resource type
put("Ge4_1runningsub","RGAGe4_RUNNING");
put("Ge4_1emissionsub","RGAGe4_EMISSION");
put("Ge4_1degassub","RGAGe4_DEGAS");
put("Ge4_1modesub","RGAGe4_MODE");
put("Ge4_1filamentsub","RGAGe4_FILAMENT");
// Chamber 2 RGA (RGAGe42)
put("Ge4_2","RGAGe42_RUNNING");     // D resource type (visibility)
put("Ge4_2Col","RGAGe42_RUNNING");  // G resource type
put("Ge4_2runningsub","RGAGe42_RUNNING");
put("Ge4_2emissionsub","RGAGe42_EMISSION");
put("Ge4_2degassub","RGAGe42_DEGAS");
put("Ge4_2modesub","RGAGe42_MODE");
put("Ge4_2filamentsub","RGAGe42_FILAMENT");

//
// Dry Pumps
//
put("DryP22_1","M1_P22ST");
put("DryP22_1Col","M1_P22ST");
put("DryP22_2","M3_P22ST");
put("DryP22_2Col","M3_P22ST");

//
// Turbo Pumps
//
put("TurboP21_1","DCU1_P21ST");
put("TurboP21_1Col","DCU1_P21ST");
put("TurboP21_1SpeedVal","DCU1_P21SPEED");
put("TurboP21_1PowerVal","DCU1_P21PWR");
put("TurboP21_1Stysub","DCU1_P21STYST");
put("TurboP21_1Tempsub","DCU1_P21TPST");
put("TurboP21_1BTempsub","DCU1_P21BTPST");
put("TurboP21_1Errsub","DCU1_P21BERR");
put("TurboP21_1TempValsub","NULL");
put("TurboP21_1BTempValsub","NULL");
put("TurboP21_1SpeedValsub","DCU1_P21SPEED");
put("TurboP21_1PowerValsub","DCU1_P21PWR");
put("TurboP21_1FspeedValsub","DCU1_P21FSPEED");
put("TurboP21_1HoursValsub","DCU1_P21HR");
put("TurboP21_2","DCU2_P21ST");
put("TurboP21_2Col","DCU2_P21ST");
put("TurboP21_2SpeedVal","DCU2_P21SPEED");
put("TurboP21_2PowerVal","DCU2_P21PWR");
put("TurboP21_2Stysub","DCU2_P21STYST");
put("TurboP21_2Tempsub","DCU2_P21TPST");
put("TurboP21_2BTempsub","DCU2_P21BTPST");
put("TurboP21_2Errsub","DCU2_P21BERR");
put("TurboP21_2TempValsub","NULL");
put("TurboP21_2BTempValsub","NULL");
put("TurboP21_2SpeedValsub","DCU2_P21SPEED");
put("TurboP21_2PowerValsub","DCU2_P21PWR");
put("TurboP21_2FspeedValsub","DCU2_P21FSPEED");
put("TurboP21_2HoursValsub","DCU2_P21HR");

//
// Bypass
//
put("BypassG22_1Val","M1_BYPASSST");
put("BypassG22_2Val","M3_BYPASSST");
put("BypassGpVal","M2_BYPASSST");   // single Gp bypass on M2 (chamber 1 vent)
...
//
/***********************************************************************/
Hashtable<String, String> CaosStatusDetails = new Hashtable<String, String>(){

private static final long serialVersionUID = 354054054058L;
{
// Chamber 1 (BEAM SPLITTER)
put("AlarmComMaxigauge_1","MG1_COMST");
put("AlarmComMaxigauge_1Str","MG1_COMST");
put("AlarmComMaxigauge_1Col","MG1_COMST");
put("AlarmComTurboP21_1","DCU1_P21COMST");
put("AlarmComTurboP21_1Str","DCU1_P21COMST");
put("AlarmComTurboP21_1Col","DCU1_P21COMST");
...
put("AirCompressed1","M1_COMPRESSAIRST");
put("AirCompressed1Str","M1_COMPRESSAIRST");
put("AirCompressed1Col","M1_COMPRESSAIRST");
put("AirCompressed2","M2_COMPRESSAIRST");
put("AirCompressed2Str","M2_COMPRESSAIRST");
put("AirCompressed2Col","M2_COMPRESSAIRST");
put("BypassG22_1","M1_BYPASSST");
put("BypassG22_1Str","M1_BYPASSST");
put("BypassG22_1Col","M1_BYPASSST");
put("BypassGp","M2_BYPASSST");      // single Gp bypass on M2 (chamber 1 vent)
put("BypassGpStr","M2_BYPASSST");
put("BypassGpCol","M2_BYPASSST");
// Chamber 2 (EST END)
put("AlarmComMaxigauge_2","MG2_COMST");
put("AlarmComMaxigauge_2Str","MG2_COMST");
put("AlarmComMaxigauge_2Col","MG2_COMST");
put("AlarmComTurboP21_2","DCU2_P21COMST");
put("AlarmComTurboP21_2Str","DCU2_P21COMST");
put("AlarmComTurboP21_2Col","DCU2_P21COMST");
put("AlarmComM3","M3_COMST");
put("AlarmComM3Str","M3_COMST");
put("AlarmComM3Col","M3_COMST");
put("AlarmComM4","M4_COMST");
put("AlarmComM4Str","M4_COMST");
put("AlarmComM4Col","M4_COMST");
put("AirCompressed3","M3_COMPRESSAIRST");
put("AirCompressed3Str","M3_COMPRESSAIRST");
put("AirCompressed3Col","M3_COMPRESSAIRST");
put("AirCompressed4","M4_COMPRESSAIRST");
put("AirCompressed4Str","M4_COMPRESSAIRST");
put("AirCompressed4Col","M4_COMPRESSAIRST");
put("BypassG22_2","M3_BYPASSST");
put("BypassG22_2Str","M3_BYPASSST");
put("BypassG22_2Col","M3_BYPASSST");
}};

//
// CAOS Temperature sensors
//
/***********************************************************************/
Hashtable<String, String> CaosTemp = new Hashtable<String, String>(){
