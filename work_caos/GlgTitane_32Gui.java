...
public class GlgTitane_32Gui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Titane Gui case
       STATUS.clear();
       STATUS.put("Pname", CAOSSTATUS.get(origin));
       STATUS.put("P", CAOSSTATUS.get(origin));
       STATUS.put("PCol", CAOSSTATUS.get(origin));
       STATUS.put("PStr", CAOSSTATUS.get(origin));
       STATUS.put("PStart", CAOSSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartCol", CAOSSTATUS.get(origin + "Startsub"));
       STATUS.put("PStartStr", CAOSSTATUS.get(origin + "Startsub"));
       STATUS.put("PCtrl", CAOSSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlCol", CAOSSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PCtrlStr", CAOSSTATUS.get(origin + "Ctrlsub"));
       STATUS.put("PErr", CAOSSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrCol", CAOSSTATUS.get(origin + "Errsub"));
       STATUS.put("PErrStr", CAOSSTATUS.get(origin + "Errsub"));
       STATUS.put("PREmode", CAOSSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeCol", CAOSSTATUS.get(origin + "REmodesub"));
       STATUS.put("PREmodeStr", CAOSSTATUS.get(origin + "REmodesub"));
       STATUS.put("PFILmode", CAOSSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeCol", CAOSSTATUS.get(origin + "FILmodesub"));
       STATUS.put("PFILmodeStr", CAOSSTATUS.get(origin + "FILmodesub"));
       STATUS.put("POPmode", CAOSSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeCol", CAOSSTATUS.get(origin + "OPmodesub"));
       STATUS.put("POPmodeStr", CAOSSTATUS.get(origin + "OPmodesub"));
       STATUS.put("PCTRLOPmode", CAOSSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeCol", CAOSSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PCTRLOPmodeStr", CAOSSTATUS.get(origin + "CTRLOPmodesub"));
       STATUS.put("PAcurrentVal", CAOSSTATUS.get(origin + "AcurrentValsub"));
       STATUS.put("PAvoltageVal", CAOSSTATUS.get(origin + "AvoltageValsub"));
       STATUS.put("PSublcurrentVal", CAOSSTATUS.get(origin + "SublcurrentValsub"));
       STATUS.put("PSubltimeVal", CAOSSTATUS.get(origin + "SubltimeValsub"));
       STATUS.put("PSublperiodVal", CAOSSTATUS.get(origin + "SublperiodValsub"));
       STATUS.put("PSublwaitVal", CAOSSTATUS.get(origin + "SublwaitValsub"));
       STATUS.put("PCycleVal", CAOSSTATUS.get(origin + "CycleValsub"));
       STATUS.put("PHrVal", CAOSSTATUS.get(origin + "HrValsub"));
       STATUS.put("PBTempVal", CAOSSTATUS.get(origin + "BTempValsub"));
    }
