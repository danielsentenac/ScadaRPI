...
public class GlgXGSGaugeGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // Gauge Gui case
       STATUS.clear();
       STATUS.put("XGSGename", CAOSSTATUS.get(origin));
       STATUS.put("XGSGeEstatus", CAOSSTATUS.get(origin));
       STATUS.put("XGSGeDstatus", CAOSSTATUS.get(origin));
       STATUS.put("XGSGeVal", CAOSSTATUS.get(origin + "Val"));
       STATUS.put("XGSGeECol", CAOSSTATUS.get(origin + "EColsub"));
       STATUS.put("XGSGeEStr", CAOSSTATUS.get(origin + "Esub"));
       STATUS.put("XGSGeDCol", CAOSSTATUS.get(origin + "DColsub"));
       STATUS.put("XGSGeDStr", CAOSSTATUS.get(origin + "Dsub"));
       STATUS.put("XGSGeFCol", CAOSSTATUS.get(origin + "FColsub"));
       STATUS.put("XGSGeFStr", CAOSSTATUS.get(origin + "Fsub"));
    }
