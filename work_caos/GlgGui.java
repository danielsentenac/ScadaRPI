...
public class GlgGui extends JFrame implements ChannelList, Runnable  {
    ...
    private String title;  // combined station title for child popups (e.g. rack status/temp)
    ...
    public GlgGui (DeviceManager _deviceManager, String _title1, String _title2) {
    ...
    private void createAndShowGui () {
	  ...
	  content.add( glg_bean );
          ...
          glg_bean.SetSTag("title_1", title1, true);
          glg_bean.SetSTag("title_2", title2, true);
          }
          catch (Exception ex) {
    ...
    public void updateGui() {
       ...
       for (Map.Entry<String, String> e : CAOSSTATUS.entrySet()) {
              ...
              if ( visibility > 0.8)  {
                 ...
                 if (showWindow == true) {
                    ...
                    if ( child == null ) {
                       ...
                       if ( origin.equals("CaosStatusDetails") )
                          child = new GlgCaosStatusDetailsGui(parent, deviceManager, title, origin);
                       else if ( origin.equals("CaosTemp") )
                          child = new GlgCaosTempGui(parent, deviceManager, title, origin);
