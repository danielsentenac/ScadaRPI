...
public class GlgRGAGui extends GlgChildGui {
    ...
    protected void createStatusMap(Hashtable < String, String > STATUS) {
       ...
       // RGA Gui case
       STATUS.clear();
       STATUS.put("RGAemission", CAOSSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionCol", CAOSSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAemissionStr", CAOSSTATUS.get(origin + "emissionsub"));
       STATUS.put("RGAdegas", CAOSSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasCol", CAOSSTATUS.get(origin + "degassub"));
       STATUS.put("RGAdegasStr", CAOSSTATUS.get(origin + "degassub"));
       STATUS.put("RGArunning", CAOSSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningCol", CAOSSTATUS.get(origin + "runningsub"));
       STATUS.put("RGArunningStr", CAOSSTATUS.get(origin + "runningsub"));
       STATUS.put("RGAmode", CAOSSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeCol", CAOSSTATUS.get(origin + "modesub"));
       STATUS.put("RGAmodeStr", CAOSSTATUS.get(origin + "modesub"));
       STATUS.put("RGAfilament", CAOSSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentCol", CAOSSTATUS.get(origin + "filamentsub"));
       STATUS.put("RGAfilamentStr", CAOSSTATUS.get(origin + "filamentsub"));
