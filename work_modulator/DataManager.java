  ...
  public void updateModbusRegisters() {
     ...
     for (Map.Entry<String, DataElement> e : dataList.entrySet()) {
        ...
        if ( dataElement.type != DataType.TRIGGER  ) { // Exclude Trigger commands
           try {
             logger.finer("DataManager:updateModbusRegisters> data typeClass " + dataElement.type 
             ...
             switch (dataElement.mbRegisterType) {
              case INT8:  holdingRegisters.setInt8At(dataElement.mbRegisterOffset, ((byte)(dataElement.value)));
                 break;
              case INT16: holdingRegisters.setInt16At(dataElement.mbRegisterOffset, ((short)(Math.abs(dataElement.value))));
                 break;
              ...
              logger.log(Level.SEVERE, "DataManager:updateModbusRegisters> " + dataElement.name + ":" + dataElement.value + ":" + ex.getMessage());
           }
